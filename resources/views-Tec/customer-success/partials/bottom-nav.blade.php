...
<nav class="mobile-nav">
  ...
  <a class="mobile-nav-item {{ $active === 'customer-success-usuarios' ? 'active' : '' }}" href="{{ route('customer-success.gestion-usuarios') }}">
  ...
  <a class="mobile-nav-item {{ $active === 'customer-success-tickets' ? 'active' : '' }}" href="{{ route('customer-success.tickets') }}">
