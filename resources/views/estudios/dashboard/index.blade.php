...
@push('styles')
@include('estudios.dashboard.dashboard-css')
@endpush
...
@section('content')
  ...
  <div id="capturasView" style="display:none">
        ...
        <div class="print-sheet-wrap">
          <div class="print-sheet" id="printSheet">
            ...
            <div class="print-img-row">
              <div class="print-img-thumb"><img src="{{ asset('images/captura1.jpg') }}" alt="Imagen 1"></div>
            ...
            <div class="print-img-row">
              <div class="print-img-thumb"><img src="{{ asset('images/captura1.jpg') }}" alt="Imagen 2"></div>
              <div class="print-img-info">
            ...
            <div class="print-img-row">
              <div class="print-img-thumb"><img src="{{ asset('images/captura1.jpg') }}" alt="Imagen 3"></div>
              <div class="print-img-info">
    ...
    {{-- Modal: Confirmar cancelar impresión --}}
...
@push('scripts')
@include('estudios.dashboard.dashboard-js')
@endpush
