...
@section('title', 'Nuevo Informe Médico')
...
@section('content')
<!-- Modal Nuevo Informe -->
<div class="inf-modal-overlay open" id="infModalOverlay">
  <div class="inf-modal">
    <!-- Cabecera -->
    <div class="inf-modal-head">
      <h3 class="inf-modal-title">Nuevo Informe Médico</h3>
      <button class="inf-modal-close" id="infModalClose" aria-label="Cerrar modal" onclick="window.history.back()">
    ...
    <div class="inf-modal-footer">
      <button class="inf-modal-btn cancel" onclick="window.history.back()">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        Cancelar
      </button>
      <button class="inf-modal-btn" style="background:#10b981;border:none;color:#ffffff" onclick="abrirExportModal()">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
        Exportar
      </button>
      <button class="inf-modal-btn submit" onclick="guardarInforme()">
...
<div class="inf-modal-overlay" id="exportModalOverlay" style="display:none">
  <div class="inf-modal" style="max-width:500px">
    <div class="inf-modal-head">
      <h3 class="inf-modal-title">Exportar Informe</h3>
      <button class="inf-modal-close" onclick="cerrarExportModal()" aria-label="Cerrar modal">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
      </button>
    </div>
    <div class="inf-modal-body">
      <div class="inf-export-options">
        <div class="inf-export-btn" onclick="exportarInforme('pdf')">
          <div class="inf-export-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          </div>
          <h5 class="inf-export-name">Exportar PDF</h5>
        </div>
        <div class="inf-export-btn" onclick="exportarInforme('print')">
        ...
        <div class="inf-export-btn" onclick="exportarInforme('email')">
        ...
        <div class="inf-export-btn" onclick="exportarInforme('cloud')">
        ...
        <div class="inf-export-btn" onclick="exportarInforme('expediente')">
        ...
        <div class="inf-export-btn" onclick="exportarInforme('share')">
...
(function(){
  ...
  // Guardar informe
  window.guardarInforme = function() {
