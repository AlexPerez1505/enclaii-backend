...
@section('header-title', 'Detalle del ticket')
...
<div class="tk-page">
  <div class="tk-back-wrap">
    <a href="{{ route('soporte.tickets') }}" class="tk-back-btn">
  ...
  <div class="tk-col">
    ...
    <div class="tk-card tk-card-glow">
      ...
      <div class="tk-card-header">
        <div class="tk-card-icon {{ $isResolved ? 'green' : 'amber' }}">
      ...
      <div class="tk-card-body">
        ...
        <div class="tk-field">
          ...
          <div class="tk-attachment-preview">
            <a href="{{ asset('storage/'.$ticket->attachment_path) }}" target="_blank" title="Ver imagen completa">
              <img class="tk-attachment-img" src="{{ asset('storage/'.$ticket->attachment_path) }}" alt="Adjunto del ticket">
            </a>
          </div>
          @endif
        </div>
        ...
        <a href="{{ route('soporte.tickets') }}" class="tk-action-btn" style="margin-top:6px">
    ...
    @if($isResolved && $ticket->resolution_summary)
      ...
      <div class="tk-card-body">
        <div class="tk-resolution-detail">
          ...
          <div class="tk-resolution-row">
            ...
            <div class="tk-resolution-value"><pre>{{ $ticket->resolution_summary }}</pre></div>
          </div>
          @endif
