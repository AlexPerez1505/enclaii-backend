...
<div class="cfg-panel active" data-panel="general">
  <div class="cfg-col">
    ...
    <article class="card rise d2">
      ...
      <div class="cfg-row">
        <span class="cfg-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4"/></svg></span>
        <div class="cfg-info"><div class="t">Tema de la aplicación</div><div class="d">Selecciona el tema de la interfaz</div></div>
      ...
      <div class="cfg-row">
        ...
        <div class="cfg-select">
          <select><option>(GMT-06:00) Ciudad de México</option><option>(GMT-05:00) Bogotá</option><option>(GMT-03:00) Buenos Aires</option></select>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
      </div>
      ...
      <div class="cfg-row">
        ...
        <div class="cfg-select">
          <select><option>12 horas (AM/PM)</option><option>24 horas</option></select>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
      </div>
      ...
      <div class="cfg-row">
        ...
        <div class="cfg-select">
          <select><option>Dashboard</option><option>IA Reportes</option><option>Agenda</option></select>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
      </div>
