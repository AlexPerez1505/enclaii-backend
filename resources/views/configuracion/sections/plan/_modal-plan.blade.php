      ...
      <div class="gp-panel active" data-gppanel="resumen">
            ...
            <div class="gp-plan">
              ...
              <div class="gp-plan-info">
                ...
                @if($planUser->subscription_renews_at)
                  <p>Renovacion {{ format_user_date($planUser->subscription_renews_at) }}</p>
                @endif
        ...
        <div class="gp-cancel gp-resume" id="resumeBox">
          ...
          <div class="gp-cancel-txt">
            ...
            <p>Tu plan permanecerá activo hasta el <b>{{ format_user_date($planUser->subscription_cancel_at) }}</b>. Después perderás el acceso a las funciones premium.</p>
          </div>
      ...
      <div class="gp-panel" data-gppanel="facturacion">
        <section class="gp-card">
          ...
          <div class="gp-summary-row">
            ...
            <span>{{ format_user_date($planUser->subscription_renews_at) }}</span>
          </div>
          @endif
          @if($planUser->pm_last_four)
          <div class="gp-summary-row">
