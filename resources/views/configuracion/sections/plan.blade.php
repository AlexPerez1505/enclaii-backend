  ...
  <div class="pl-grid">
    ...
    <div class="cfg-col">
      <article class="card rise d2">
        ...
        <div class="pl-plan">
          ...
          <div class="pl-info">
            <b>Plan Profesional</b><span class="badge">Activo</span>
        ...
        <div class="pl-detail" style="margin-top:18px">
          ...
          <div class="pl-files">
            <div class="pl-file"><span class="fi c1"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></span><div class="ft">Informes</div><div class="fv">24.5 GB</div><div class="fp">31%</div></div>
      ...
      <article class="card rise d4">
        ...
        <div class="pl-plans">
          <div class="pl-card">
            <div class="pc-top"><span class="pc-ico" style="color:var(--green)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg></span></div>
            ...
            <div class="pc-price">$199<span> /mes</span></div>
            <a href="#" class="pc-cta">Cambiar a Clinica</a>
          </div>

          <div class="pl-card current">
            <div class="pc-top"><span class="pc-ico" style="color:#a47bff"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8l4 3 5-7 5 7 4-3-2 12H5L3 8z"/></svg></span><span class="pc-badge">Plan actual</span></div>
            ...
            <div class="pc-price">$399<span> /mes</span></div>
            <span class="pc-cta disabled">Plan actual</span>
          </div>

          <div class="pl-card">
            <div class="pc-top"><span class="pc-ico" style="color:var(--red)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg></span></div>
            ...
            <div class="pc-price">$699<span> /mes</span></div>
            <a href="#" class="pc-cta">Cambiar a Red Médica</a>
          </div>

          <div class="pl-card">
            <div class="pc-top"><span class="pc-ico" style="color:var(--green)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2z"/></svg></span></div>
            <h4>Empresarial</h4><div class="pc-gb">1 TB</div>
            <ul class="pc-feat">
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Todo del plan Avanzado</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Almacenamiento ilimitado</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Multiusuarios</li>
              <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>Administrador dedicado</li>
            </ul>
            <div class="pc-price">$1,299<span> /mes</span></div>
            <a href="#" class="pc-cta">Cambiar Empresarial</a>
          </div>
        </div>
      </article>
    </div>
    ...
    <div class="cfg-col">
      <article class="card rise d3">
        ...
        <div class="pl-summary-row"><span class="k">Plan actual</span><span class="v">Plan profesional</span></div>
        <div class="pl-summary-row"><span class="k">Almacenamiento incluido</span><span class="v">100 GB</span></div>
        <div class="pl-summary-row"><span class="k">Uso actual</span><span class="v">75.5 GB (78%)</span></div>
        <div class="pl-summary-row"><span class="k">Almacenamiento disponible</span><span class="v">21.5 GB</span></div>
        <div class="pl-summary-row"><span class="k">Renovación</span><span class="v">05/12/2025</span></div>
        <div class="pl-summary-row"><span class="k">Método de pago</span><span class="v pl-pay"><span class="pl-mc"></span>····4587</span></div>
      </article>

      <article class="card rise d4">
        <div class="cfg-card-head"><h2>Facturación y pago</h2></div>
        <a href="#" class="pl-link"><span>Próxima fecha de cobro</span><span class="v">05/12/2025</span></a>
        <a href="#" class="pl-link"><span>Monto a cobrar</span><span class="v">$399 /mes</span></a>
        <a href="#" class="pl-link"><span>Historial de facturas</span><span class="v">Ver</span></a>
        <a href="#" class="pl-wide-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg> Actualizar método de pago</a>
      </article>
