...
(function(){
  ...
  const verifyUrl = @json(route('configuracion.security.authorize'));
  const requirements = {
    patients: @json($criticalSecurity['require_password_for_patients']),
    studies: @json($criticalSecurity['require_password_for_studies']),
