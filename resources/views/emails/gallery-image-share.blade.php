@php
  ...
  $studyFolio = $estudio?->folio ?? ('Imagen #'.$archivo->id);
@endphp
  ...
  <div style="max-width:640px;margin:0 auto;padding:28px 18px">
    <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden">
      <div style="padding:22px 24px;border-bottom:1px solid #e2e8f0">
        ...
        <h1 style="margin:8px 0 0;font-size:20px;line-height:1.35;color:#111827">Imagen de estudio compartida</h1>
      </div>
      ...
      <div style="padding:24px">
        ...
        <p style="margin:18px 0 22px;font-size:13px;line-height:1.6;color:#64748b">
          El enlace puede abrirse desde el navegador para visualizar o descargar la imagen.
        </p>

        <a href="{{ $imageUrl }}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-weight:700;font-size:14px;padding:12px 18px;border-radius:10px">
          Abrir imagen
        </a>
