...
const ESTUDIO_BASE = @json(route('nuevo-estudio'));
function estudyUrl(p) {
  const params = new URLSearchParams({ name: p.name||'', age: p.age||'', gender: p.gender||'', dob: p.dob||'' });
  return ESTUDIO_BASE + '?' + params.toString();
}
