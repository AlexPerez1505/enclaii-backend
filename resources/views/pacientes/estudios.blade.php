...
@section('title', 'Estudios del Paciente')
@section('active', 'pacientes')
@section('header-title', 'Estudios del paciente')
@section('header-sub') Gestiona los estudios, imágenes, videos y reportes @endsection
...
@section('content')
<a href="{{ route('pacientes.edit') }}" class="back-link rise d1">
...
<div id="tab-estudios" class="tab-content active rise d3">
  ...
  {{-- Resumen de media en pestaña Estudios --}}
...
<div class="form-footer rise d4">
  <a href="{{ route('pacientes.edit') }}" class="btn-cancel">Cancelar</a>
  <a href="{{ route('pacientes.edit') }}" class="btn-save">
