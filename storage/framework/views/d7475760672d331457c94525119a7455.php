...
<div class="np-layout" id="npFormLayout" style="display:none">
  ...
  <div class="np-side rise d4">
    <div class="np-action-btns">
      ...
      <a class="np-action-btn" href="<?php echo e(route('nuevo-estudio.configuracion')); ?>">
  ...
  <div class="pa-shell rise d3">
    ...
    <aside class="pa-side">
      <section class="pa-panel">
        ...
        <div class="pa-info">
          <div class="pa-info-row"><span>ID</span><strong id="npGalSideId"><?php echo e($galCodigo); ?></strong></div>
          <div class="pa-info-row"><span>Sexo</span><strong id="npGalSideSexo"><?php echo e($galSexo); ?></strong></div>
          <div class="pa-info-row"><span>Edad</span><strong id="npGalSideEdad"><?php echo e($galEdad); ?></strong></div>
          <div class="pa-info-row"><span>Estado</span><strong id="npGalSideEstado" style="color:var(--green)">Activo</strong></div>
          <div class="pa-info-row"><span>Ultimo estudio</span><strong id="npGalSideUltimo"><?php echo e($galUltimo); ?></strong></div>
        </div>
      </section>
...
<div class="ns-modal-backdrop" id="nsModalBackdrop">
  <div class="ns-modal" id="nsModal">
    ...
    <div class="ns-modal-body">
      <a class="ns-option" href="<?php echo e(route('nuevo-estudio.importar')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gmedi\enclaii-backend\resources\views/estudios/crear.blade.php ENDPATH**/ ?>