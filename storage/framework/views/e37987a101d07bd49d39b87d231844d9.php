  ...
  <?php else: ?>
    <table class="cs-table">
      ...
      <tbody>
        ...
        ?>
        <tr data-id="<?php echo e($anuncio->id); ?>"
            data-titulo="<?php echo e($anuncio->titulo); ?>"
            data-tipo="<?php echo e($anuncio->tipo); ?>"
            data-publico="<?php echo e($anuncio->publico_objetivo ?? 'todos'); ?>"
            data-canales="<?php echo e(implode(',', is_array($anuncio->canales) ? $anuncio->canales : ['web'])); ?>"
            data-fecha="<?php echo e($anuncio->fecha_publicacion?->format('Y-m-d\TH:i') ?? ''); ?>"
            data-contenido="<?php echo e(json_encode($anuncio->contenido)); ?>">
          <td>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            <span class="cs-title-text" title="<?php echo e($anuncio->titulo); ?>"><?php echo e($anuncio->titulo); ?></span>
          </td>
          <td>
            <span class="cs-badge cs-badge-<?php echo e($tipoKey); ?>">
              <?php echo $tipoIconos[$tipoKey] ?? ''; ?>

              <?php echo e($tipoLabels[$tipoKey] ?? $tipoKey); ?>
          ...
          <td>
            <span class="cs-badge" style="background:rgba(99,102,241,.12);color:#a5b4fc;border:1px solid rgba(99,102,241,.22)">
              ...
              <?php echo e($publicoLabels[$anuncio->publico_objetivo ?? 'todos'] ?? 'Todos'); ?>
          ...
          <td>
            <span style="display:inline-flex;align-items:center;gap:5px;font-size:12px;color:#94a3b8">
              ...
              <?php echo e(is_array($anuncio->canales) ? implode(', ', $anuncio->canales) : 'web'); ?>

            </span>
          </td>
          <td>
            <span style="display:inline-flex;align-items:center;gap:7px">
              <span class="cs-avatar"><?php echo e($initials); ?></span>
              <?php echo e($anuncio->user->name ?? '—'); ?>

            </span>
          </td>
          <td style="font-size:12px;color:#94a3b8">
            <?php if($anuncio->fecha_publicacion && $anuncio->fecha_publicacion->isFuture()): ?>
              <span class="cs-badge cs-badge-programado" style="margin-bottom:3px">Programado</span><br>
              <?php echo e($anuncio->fecha_publicacion->format('d/m/Y H:i')); ?>

            <?php elseif($anuncio->fecha_publicacion): ?>
              <?php echo e($anuncio->fecha_publicacion->format('d/m/Y H:i')); ?>

            <?php else: ?>
              <?php echo e($anuncio->created_at->format('d/m/Y H:i')); ?>
          ...
          <td>
            ...
            <?php elseif($anuncio->fecha_publicacion && $anuncio->fecha_publicacion->isFuture()): ?>
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views-Tec/customer-success/anuncios/_lista.blade.php ENDPATH**/ ?>