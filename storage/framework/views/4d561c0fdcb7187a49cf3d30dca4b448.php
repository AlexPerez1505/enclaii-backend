...
<?php $__env->startSection('active','mensajes'); ?>
<?php $__env->startSection('header-title','Mensajes'); ?>
<?php $__env->startSection('header-sub'); ?> Gestiona tus conversaciones con pacientes <?php $__env->stopSection(); ?>

<?php $__env->startSection('header-extra'); ?>
<?php if(request()->query('desde') === 'estudio_terminado' && request()->integer('estudio_id') > 0): ?>
<a class="btn-return-study" href="<?php echo e(route('nuevo-estudio.grabando', ['estudio_id' => request()->integer('estudio_id'), 'vista' => 'finalizado'])); ?>">
...
<div class="msg-page" id="msgPage">
  ...
  <div class="msg-sidebar">
    ...
    <div class="msg-list" id="convList">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $whatsappContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php ($contactColor = $contactColors[$loop->index % count($contactColors)]); ?>
        <div
          class="conv-item"
          data-tab="<?php echo e($contact['unread'] > 0 ? 'todas noleidos' : 'todas'); ?>"
          data-type="wa"
          data-patient-id="<?php echo e($contact['id']); ?>"
          data-name="<?php echo e($contact['name']); ?>"
          data-initials="<?php echo e($contact['initials']); ?>"
          data-color="<?php echo e($contactColor); ?>"
          data-messages-url="<?php echo e(route('mensajes.whatsapp.messages', $contact['id'])); ?>"
          onclick="openWhatsAppPatient(this)">
          <div class="conv-avatar <?php echo e($contactColor); ?>"><?php echo e($contact['initials']); ?></div>
          <div class="conv-body">
            <div class="conv-name"><?php echo e($contact['name']); ?></div>
            <div class="conv-preview"><?php echo e(Str::limit($contact['preview'], 46)); ?></div>
          </div>
          <div class="conv-meta">
            <div class="conv-time"><?php echo e($contact['time']); ?></div>
            <?php if($contact['unread'] > 0): ?>
              <div class="conv-badge"><?php echo e(min($contact['unread'], 99)); ?></div>
            <?php endif; ?>
          ...
          <div class="email-compose-card">
            <div class="email-field">
              ...
              <div class="email-from">
                ...
                <span id="emailFrom"><?php echo e(auth()->user()?->email ?? 'Sin correo registrado'); ?></span>
              </div>
      ...
      <div class="ch-group">
        ...
        <div class="ch-item active-wa">
          ...
          <div class="ch-info">
            ...
            <div class="ch-sub"><?php echo e($whatsappBusinessPhone); ?></div>
          </div>
          <div class="ch-badge <?php echo e($whatsappConfigured && $whatsappWebhookConfigured ? 'green' : ''); ?>">
            <?php echo e(! $whatsappConfigured ? 'Falta configurar' : ($whatsappWebhookConfigured ? 'Activo' : 'Falta App Secret')); ?>
...
(function(){
  ...
  const launchContext = <?php echo json_encode($whatsappLaunchContext, 15, 512) ?>;
  const csrfToken = <?php echo json_encode(csrf_token(), 15, 512) ?>;
  const whatsappSendUrl = <?php echo json_encode(route('mensajes.whatsapp.send'), 15, 512) ?>;
  const emailVideoSendUrl = <?php echo json_encode(route('mensajes.correo.video.send'), 15, 512) ?>;
  const whatsappConfigured = <?php echo json_encode($whatsappConfigured, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/mensajes/dashboard.blade.php ENDPATH**/ ?>