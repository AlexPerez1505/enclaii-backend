      ...
      <?php $__empty_1 = true; $__currentLoopData = $configurationBackups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="int-backup-row" data-backup-row="<?php echo e($backup->id); ?>">
          ...
          <div class="int-backup-actions">
            <button type="button" class="int-backup-action restore" data-backup-restore="<?php echo e($backup->id); ?>" data-backup-name="<?php echo e($backup->name); ?>">
            ...
            <button type="button" class="int-backup-action delete" data-backup-delete="<?php echo e($backup->id); ?>" data-backup-name="<?php echo e($backup->name); ?>">
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views/configuracion/sections/integraciones/_copias.blade.php ENDPATH**/ ?>