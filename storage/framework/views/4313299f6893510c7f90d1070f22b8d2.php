...
<aside class="side">
  ...
  <a class="nav-item <?php echo e($active === 'customer-success-dashboard' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.dashboard')); ?>" title="Inicio">
  ...
  <a class="nav-item <?php echo e($active === 'customer-success' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.anuncios')); ?>" title="Anuncios">
  ...
  <a class="nav-item <?php echo e($active === 'customer-success-usuarios' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.gestion-usuarios')); ?>" title="Gestión de usuarios">
  ...
  <a class="nav-item <?php echo e($active === 'customer-success-tickets' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.tickets')); ?>" title="Tickets" style="position:relative">
    ...
    <?php $openTicketsCount = \App\Models\Ticket::where('status', '!=', 'cerrado')->count(); ?>
    <?php if($openTicketsCount > 0): ?>
      <span style="position:absolute;top:6px;right:6px;background:#f59e0b;color:#fff;font-size:10px;font-weight:700;min-width:16px;height:16px;border-radius:99px;display:flex;align-items:center;justify-content:center;padding:0 4px"><?php echo e($openTicketsCount); ?></span>
    <?php endif; ?>
  </a>

  <a class="nav-item <?php echo e($active === 'customer-success-soporte' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.soporte')); ?>" title="Soporte" style="position:relative">
    ...
    <?php $pendingCount = \App\Models\AiConversation::where('type','soporte')->where('mode','pending_agent')->count(); ?>
    <?php if($pendingCount > 0): ?>
      <span style="position:absolute;top:6px;right:6px;background:#f59e0b;color:#fff;font-size:10px;font-weight:700;min-width:16px;height:16px;border-radius:99px;display:flex;align-items:center;justify-content:center;padding:0 4px"><?php echo e($pendingCount); ?></span>
    <?php endif; ?>
  </a>
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views-Tec/customer-success/partials/sidebar.blade.php ENDPATH**/ ?>