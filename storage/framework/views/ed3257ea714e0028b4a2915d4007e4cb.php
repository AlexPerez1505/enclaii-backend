...
<dialog id="ec-auth-dialog">
    <div class="ec-auth-modal ec-shake">
        ...
        <form method="POST" action="<?php echo e(route('2fa.verify')); ?>" class="ec-auth-form">
            <?php echo csrf_field(); ?>
...
if(resendBtn) {
    resendBtn.addEventListener('click', async () => {
        const res = await fetch('<?php echo e(route('2fa.resend')); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views/auth/two-factor-challenge.blade.php ENDPATH**/ ?>