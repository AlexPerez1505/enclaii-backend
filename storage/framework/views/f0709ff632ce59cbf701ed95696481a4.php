...
<div class="ag-card" id="stepCita">
  ...
  <div class="ag-row ag-field">
    <div>
      ...
      <div class="ag-input-icon">
        ...
        <input class="ag-input" id="citaFecha" type="text" placeholder="<?php echo e(str_replace(['d','m','Y'], ['DD','MM','AAAA'], user_date_format())); ?>" value="<?php echo e(date(user_date_format())); ?>" readonly>
      </div>
    </div>
  ...
  <select class="ag-input ag-select" name="sala_id" id="citaSala">
    ...
    <?php $__currentLoopData = $salas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sala): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($sala->id); ?>" <?php echo e(($citaData['sala_id'] ?? null) == $sala->id ? 'selected' : ''); ?>>
...
<script>
(function(){
  const DATE_FORMAT = <?php echo json_encode(auth()->user()?->settings['date_format'] ?? 'DD/MM/YYYY', 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views/agenda/agendar/_cita.blade.php ENDPATH**/ ?>