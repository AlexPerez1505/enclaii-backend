...
<div class="gi-mail-overlay" id="giMailOverlay" data-send-url="<?php echo e(route('galeria.imagen.correo.send', $archivo->id, false)); ?>">
  <div class="gi-mail-modal" role="dialog" aria-modal="true" aria-labelledby="giMailTitle">
    <div class="gi-mail-head">
      <div>
        ...
        <div class="gi-mail-sub"><?php echo e($imagePatientName); ?> - <?php echo e($imageFolio); ?></div>
      </div>
    ...
    <form class="gi-mail-form" id="giMailForm">
      ...
      <div class="gi-mail-field">
        ...
        <input id="giMailRecipients" name="recipients" type="text" value="<?php echo e($imageEmailDefaultRecipient); ?>" placeholder="correo@ejemplo.com" autocomplete="email">
        <span>Hasta 10 correos separados por coma.</span>
      </div>

      <div class="gi-mail-field">
        <label for="giMailSubject">Asunto</label>
        <input id="giMailSubject" name="subject" type="text" value="<?php echo e($imageEmailSubject); ?>" maxlength="180">
      </div>

      <div class="gi-mail-field">
        <label for="giMailMessage">Mensaje</label>
        <textarea id="giMailMessage" name="message" rows="6" maxlength="5000"><?php echo e($imageEmailMessage); ?></textarea>
      </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/galeria/_image_email_modal.blade.php ENDPATH**/ ?>