  ...
  <div class="vi-topbar">
    <a href="<?php echo e(route('galeria.paciente', $pacienteId)); ?>" class="vi-btn back">
    ...
    <div class="vi-topbar-right">
      ...
      <a class="vi-btn wa" href="<?php echo e(route('mensajes', [
        'canal' => 'whatsapp',
        'tipo' => 'imagen',
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views/galeria/verimagen/_acciones.blade.php ENDPATH**/ ?>