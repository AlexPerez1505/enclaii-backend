          ...
          <div class="select-with-add">
            <select id="anestesiologoSelect" name="anestesiologo" data-campo="anestesiologo">
              <?php if($paciente->anestesiologo): ?>
                <option value="<?php echo e(Str::slug($paciente->anestesiologo, '-')); ?>" selected><?php echo e($paciente->anestesiologo); ?></option>
              <?php endif; ?>
            </select>
        ...
        <div class="form-group" style="margin-bottom:18px;">
          ...
          <div class="select-with-add">
            <select id="referidoSelectMed" name="referido_por" data-campo="referido_por">
              <?php if($paciente->referido_por): ?>
                <option value="<?php echo e(Str::slug($paciente->referido_por, '-')); ?>" selected><?php echo e($paciente->referido_por); ?></option>
              <?php endif; ?>
            </select>
        ...
        <div class="form-group">
          ...
          <div class="select-with-add">
            <select id="equipoSelect" name="equipo_utilizado" data-campo="equipo_utilizado">
              <?php if($paciente->equipo_utilizado): ?>
                <option value="<?php echo e(Str::slug($paciente->equipo_utilizado, '-')); ?>" selected><?php echo e($paciente->equipo_utilizado); ?></option>
              <?php endif; ?>
            </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gmedi\enclaii-backend\resources\views/pacientes/edit.blade.php ENDPATH**/ ?>