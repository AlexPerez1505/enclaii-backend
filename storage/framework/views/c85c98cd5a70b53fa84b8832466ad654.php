...
<?php if(auth()->user()->esVeterinaria()): ?>
  ...
  <div class="pl-card <?php echo e(auth()->user()->stripe_plan === 'clinica_veterinaria' ? 'current' : ''); ?>" data-card="clinica_veterinaria">
    <div class="pc-top">
...
<?php endif; ?></span>
      <?php if(auth()->user()->stripe_plan === 'clinica_veterinaria'): ?>
    ...
    <a href="#" class="pc-cta <?php echo e(auth()->user()->stripe_plan === 'clinica_veterinaria' ? 'disabled' : ''); ?>" data-plan="clinica_veterinaria" data-interval="month">
      <?php echo e(auth()->user()->stripe_plan === 'clinica_veterinaria' ? 'Plan actual' : 'Contratar plan de Clínica Veterinaria'); ?>

    </a>
  </div>

  
  <div class="pl-card <?php echo e(auth()->user()->stripe_plan === 'hospital_veterinario' ? 'current' : ''); ?>" data-card="hospital_veterinario">
    <div class="pc-top">
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?></span>
      <?php if(auth()->user()->stripe_plan === 'hospital_veterinario'): ?>
        <span class="pc-badge">Plan actual</span>
      <?php endif; ?>
    </div>
    ...
    <a href="#" class="pc-cta <?php echo e(auth()->user()->stripe_plan === 'hospital_veterinario' ? 'disabled' : ''); ?>" data-plan="hospital_veterinario" data-interval="month">
      <?php echo e(auth()->user()->stripe_plan === 'hospital_veterinario' ? 'Plan actual' : 'Contratar plan de Hospital Veterinario'); ?>

    </a>
  </div>

  
  <div class="pl-card <?php echo e(auth()->user()->stripe_plan === 'red_veterinaria' ? 'current' : ''); ?>" data-card="red_veterinaria">
    <div class="pc-top">
      ...
      <?php if(auth()->user()->stripe_plan === 'red_veterinaria'): ?>
        <span class="pc-badge">Plan actual</span>
      <?php endif; ?>
    </div>
    ...
    <a href="#" class="pc-cta <?php echo e(auth()->user()->stripe_plan === 'red_veterinaria' ? 'disabled' : ''); ?>" data-plan="red_veterinaria" data-interval="month">
      <?php echo e(auth()->user()->stripe_plan === 'red_veterinaria' ? 'Plan actual' : 'Contratar plan de Red Veterinaria'); ?>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  const SETUP_INTENT_URL = "<?php echo e(route('stripe.setup.intent')); ?>";
  const PROMO_SUBSCRIBE_URL = "<?php echo e(route('stripe.promo.subscribe')); ?>";
  const RETURN_URL = "<?php echo e(route('stripe.success')); ?>";
  const STRIPE_PUBLISHABLE_KEY = "<?php echo e(config('services.stripe.key')); ?>";
  const PROMO_CHECKOUT = <?php echo json_encode($promoCheckout, 15, 512) ?>;
...
<?php echo $__env->make('layouts.plan-only', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/plan-only.blade.php ENDPATH**/ ?>