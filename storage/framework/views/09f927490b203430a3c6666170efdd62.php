...
<title>Ticket resuelto: <?php echo e($ticket->subject); ?></title>
<style>
  ...
  <div class="wrapper">
    <div class="header">
      ...
      <div>
        ...
        <p><?php echo e($ticket->operation_folio); ?></p>
      </div>
    </div>
    <div class="body">
      <div class="field">
        <div class="field-label">Asunto</div>
        <div class="field-value"><?php echo e($ticket->subject); ?></div>
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <div class="field-value"><?php echo e($typeLabel); ?></div>
      </div>
      <div class="field">
        <div class="field-label">Solución aplicada</div>
        <div class="field-value"><?php echo e($ticket->resolution_summary); ?></div>
      </div>
      <div class="field">
        <div class="field-label">Resuelto por</div>
        <div class="field-value"><?php echo e($ticket->resolver?->name); ?> <?php echo e($ticket->resolver?->apellido_paterno); ?></div>
      </div>
      <div class="field">
        <div class="field-label">Fecha</div>
        <div class="field-value"><?php echo e($ticket->resolved_at?->format('d M Y \a \l\a\s h:i A')); ?></div>
      </div>
    </div>
    <div class="footer">
      <p>Este correo fue enviado automáticamente por el sistema de soporte de Enclaii.</p>
      <p><a href="<?php echo e(route('soporte.tickets.show', $ticket)); ?>">Ver ticket en la plataforma</a></p>
    </div>
  </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views\emails\ticket-resuelto.blade.php ENDPATH**/ ?>