    ...
    <?php if($imgCount): ?>
      <div class="rep-imgs" style="<?php echo e($repImgsStyle); ?>">
        <?php $__currentLoopData = $imagenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="cell" style="grid-column:span <?php echo e($img['size']); ?>;overflow:hidden">
            <img src="<?php echo e($img['url']); ?>" alt="<?php echo e($img['titulo']); ?>" style="width:100%;height:100%;object-fit:contain;object-position:center;display:block;background:#020714">
          </span>
