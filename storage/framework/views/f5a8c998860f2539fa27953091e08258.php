    ...
    <div class="vv-dl-body">
      ...
      <div>
        ...
        <select class="vv-dl-qual" id="vvDlQual">
          <option value="original"><?php echo e($videoExtension); ?> original</option>
        </select>
        <div class="vv-dl-qual-res" id="vvQualRes"><?php echo e($downloadName); ?></div>
      </div>
      ...
      <div>
        ...
        <div class="vv-fmt-row">
          <div class="vv-fmt-card sel" data-fmt="<?php echo e($videoExtension); ?>">
            <div class="vv-fmt-ext"><?php echo e($videoExtension); ?></div>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/galeria/vervideo/_modal-descarga.blade.php ENDPATH**/ ?>