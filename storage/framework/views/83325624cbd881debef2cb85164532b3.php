...
<?php echo $__env->make('estudios.caputras.capturas-css', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="cap-toolbar rise d1">
    <a class="btn-tool" href="<?php echo e(route('nuevo-estudio.crear')); ?>">
    ...
    <div class="cap-toolbar-right">
      <a class="btn-regresar" href="<?php echo e(route('nuevo-estudio.crear')); ?>">
  ...
  <div class="cap-layout">
    ...
    <div class="cap-card rise d2">
      ...
      <div class="cap-list" id="capList">
        ...
        <?php $__currentLoopData = $capturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="cap-item" data-id="<?php echo e($c['id']); ?>"
          data-nombre="<?php echo e($c['nombre']); ?>"
          data-fecha="<?php echo e($c['fecha']); ?>"
          data-hora="<?php echo e($c['hora']); ?>"
          data-estudio="<?php echo e($c['estudio']); ?>"
          data-tipo-estudio="<?php echo e($c['tipo_estudio']); ?>"
          data-img="<?php echo e($c['img']); ?>">
          <div class="cap-thumb">
            <img src="<?php echo e(asset('images/captura1.jpg')); ?>" alt="captura">
          </div>
          <div class="cap-info">
            <div class="cap-nombre"><?php echo e($c['nombre']); ?></div>
            <div class="cap-date">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
              <?php echo e($c['fecha']); ?> <?php echo e($c['hora']); ?>

            </div>
            <div class="cap-tipo"><?php echo e($c['tipo']); ?></div>
          </div>
    ...
    <div class="cap-preview-card rise d3" id="previewCard">
      ...
      <div class="prev-img-box">
        <img id="prevImg" src="<?php echo e(asset('images/captura1.jpg')); ?>" alt="Vista previa">
      </div>
...
<?php echo $__env->make('estudios.caputras.capturas-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\estudios\caputras\index.blade.php ENDPATH**/ ?>