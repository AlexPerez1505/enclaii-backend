  ...
  <section class="rep-grid">
    ...
    <article class="card card-pred rise d7">
      ...
      <div class="risk">
        ...
        <a class="btn-line" id="predLink" href="<?php echo e(route('ia-reportes.analisis', ['p' => 0])); ?>">
...
(function(){
  ...
  const analisisBase = <?php echo json_encode(route('ia-reportes.analisis'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/ia-reportes/index.blade.php ENDPATH**/ ?>