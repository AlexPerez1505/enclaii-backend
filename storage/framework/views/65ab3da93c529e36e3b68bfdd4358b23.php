  ...
  <div class="cfg-col">
    ...
    <article class="card rise d2">
      ...
      <div class="cfg-row">
        ...
        <div class="cfg-info"><div class="t">Notificaciones generales</div><div class="d">Avisos y comunicados directos enviados por el equipo de Enclaii.</div></div>
        <div class="cfg-notif-opts">
          <label class="cfg-notif-opt email" title="Correo electrónico">
            <input type="checkbox" data-setting="notif_announcement_email">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 6L2 7"/></svg>
          </label>
          <label class="cfg-notif-opt screen" title="Aviso en pantalla">
            <input type="checkbox" data-setting="notif_announcement_screen" data-effect="push" checked>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/sections/general.blade.php ENDPATH**/ ?>