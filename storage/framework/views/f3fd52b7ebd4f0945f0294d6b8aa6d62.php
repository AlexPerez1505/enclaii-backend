  ...
  <form id="pacienteForm" class="form-card rise d2" action="<?php echo e(route('pacientes.store')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="personal-layout">
      ...
      <div class="form-group">
        ...
        <input type="tel" name="telefono" value="<?php echo e(old('telefono')); ?>" placeholder="7221620815" maxlength="10" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g,'').slice(0,10)">
      </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gmedi\enclaii-backend\resources\views/pacientes/create.blade.php ENDPATH**/ ?>