  ...
  <div class="tkt-main">
    ...
    <div class="tkt-card">
      <div class="tkt-card-header">
        ...
        <a class="tkt-new-ticket" href="<?php echo e(route('soporte')); ?>">Crear ticket</a>
      </div>
      ...
      ?>
      <form class="tkt-search" id="tktFilterForm" action="<?php echo e(route('soporte.tickets')); ?>" method="GET">
        ...
        <label class="tkt-filter">
          <select name="status">
            ...
            <option value="pendiente" <?php echo e(($status ?? '') === 'pendiente' ? 'selected' : ''); ?>>Pendiente</option>
            <option value="resuelto" <?php echo e(($status ?? '') === 'resuelto' ? 'selected' : ''); ?>>Resuelto</option>
          </select>
        </label>
        <?php if(!empty($category) || !empty($status)): ?>
          <a href="<?php echo e(route('soporte.tickets')); ?>" class="tkt-search-clear" aria-label="Limpiar">×</a>
        <?php endif; ?>
      </form>
      ...
      <div>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                  ...
                  <td title="<?php echo e($ticket->subject); ?>"><span class="tkt-title"><?php echo e(\Illuminate\Support\Str::limit($ticket->subject, 35)); ?></span></td>
                  <td title="<?php echo e($catLabel); ?>"><span class="tkt-category tkt-cat-<?php echo e(str_replace(['-','_'], '-', $ticket->category)); ?>"><?php echo e($catLabel); ?></span></td>
                  <td><span class="tkt-badge <?php echo e($isResolved ? 'resuelto' : 'pendiente'); ?>"><?php echo e($isResolved ? 'Resuelto' : 'Pendiente'); ?></span></td>
                  <td>
                    <div class="tkt-menu">
                      ...
                      <div class="tkt-menu-dropdown">
                        <a href="<?php echo e(route('soporte.tickets.show', $ticket)); ?>">
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                          Mi ticket enviado
                        </a>
                        <?php if($isResolved): ?>
                          <a class="resolved" href="<?php echo e(route('soporte.tickets.show', $ticket)); ?>#respuesta">
                ...
                <tr>
                  <td colspan="5">
                    <div class="tkt-empty">
                      ...
                      <a class="tkt-empty-link" href="<?php echo e(route('soporte')); ?>">Crear mi primer ticket →</a>
                    </div>
                  </td>
                </tr>
              <?php endif; ?>
        ...
        <div class="tkt-pagination">
          <a class="tkt-page-btn <?php echo e($tickets->onFirstPage() ? 'disabled' : ''); ?>" href="<?php echo e($tickets->previousPageUrl()); ?>">← Anterior</a>
          <span class="tkt-page-info">Página <?php echo e($tickets->currentPage()); ?> de <?php echo e($tickets->lastPage()); ?></span>
          <a class="tkt-page-btn <?php echo e(!$tickets->hasMorePages() ? 'disabled' : ''); ?>" href="<?php echo e($tickets->nextPageUrl()); ?>">Siguiente →</a>
        </div>
        <?php endif; ?>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\soporte\tickets.blade.php ENDPATH**/ ?>