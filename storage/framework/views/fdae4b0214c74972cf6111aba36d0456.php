...
<?php $__env->startSection('header-title'); ?>
  Buenos días, <?php echo e(auth()->user()?->name ?? 'Doctor'); ?>
...
<?php echo $__env->make('dashboard.widgets.next-patient.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('dashboard.widgets.ia-pending.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('dashboard.widgets.agenda-today.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('dashboard.widgets.new-study.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('dashboard.widgets.next-list.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('dashboard.widgets.agenda-summary.styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div id="widgetGrid">
    <?php echo $__env->make('dashboard.widgets.next-patient.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.ia-pending.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.agenda-today.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.new-study.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.next-list.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.agenda-summary.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>

  
  <div id="widgetGridMinimal" class="dashboard-mode-min">
    <?php echo $__env->make('dashboard.widgets.next-patient.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.ia-pending.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.agenda-today.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.new-study.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.next-list.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('dashboard.widgets.agenda-summary.minimalista', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
...
(function(){
  ...
  if (brainNextContainer && typeof lottie !== 'undefined') {
    const brainNext = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: !reduced,
      path: '<?php echo e(asset('animations/brain.json')); ?>?v=1'
    });
  ...
  if (brainContainer && typeof lottie !== 'undefined') {
    const brain = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: !reduced,
      path: '<?php echo e(asset('animations/robot.json')); ?>?v=1'
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/dashboard/index.blade.php ENDPATH**/ ?>