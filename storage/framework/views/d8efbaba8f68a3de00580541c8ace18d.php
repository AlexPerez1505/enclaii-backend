<?php $__env->startSection('title', 'Archivos del paciente'); ?>
...
<?php $__env->startSection('header-sub'); ?>
  ...
  <span style="font-size:13px;font-weight:600"><?php echo e($paciente?->nombre_completo ?? 'Paciente'); ?></span>
...
<div class="pa-topbar rise d2">
  <a href="<?php echo e(route('galeria')); ?>" class="pa-back">
...
<div class="pa-shell rise d3">
  <div>
    <section class="pa-hero">
      <div class="pa-avatar"><?php echo e($iniciales); ?></div>
      <div>
        <div class="pa-title"><?php echo e($nombrePaciente); ?></div>
        <div class="pa-sub">ID: <?php echo e($paciente?->folio ?? $paciente?->identificacion ?? '—'); ?> · <?php echo e($paciente?->sexo ?? '—'); ?> · <?php echo e($paciente?->edad ? $paciente->edad.' años' : '—'); ?> · Último estudio: <?php echo e($ultimaFecha); ?></div>
      </div>
      <div class="pa-stats">
        <div class="pa-stat"><strong><?php echo e($totalEstudios); ?></strong><span>Estudios</span></div>
        <div class="pa-stat"><strong><?php echo e($totalFotos); ?></strong><span>Fotos</span></div>
        <div class="pa-stat"><strong><?php echo e($totalVideos); ?></strong><span>Videos</span></div>
      </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/galeria/paciente.blade.php ENDPATH**/ ?>