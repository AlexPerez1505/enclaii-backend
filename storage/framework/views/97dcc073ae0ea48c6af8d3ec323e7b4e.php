...
<div class="cfg-panel" data-panel="perfil">
  ...
  <div class="pf-bottom">
    ...
    <article class="card rise d5">
      ...
      <div class="pf-2">
        <div class="pf-field"><label>RFC</label><input class="pf-input" type="text" name="rfc" value="<?php echo e($u->rfc); ?>"></div>
        <div class="pf-field"><label>Razón social</label><input class="pf-input" type="text" name="razon_social" value="<?php echo e($u->razon_social); ?>"></div>
      </div>
