...
<div class="cfg-panel" data-panel="perfil">
  ...
  <div class="pf-top">
    <article class="card rise d2">
      ...
      <div class="pf-photo">
        ...
        <div class="pf-ava-wrap">
          <img class="pf-ava" id="pfAva" src="<?php echo e($fotoPerfil ?? ''); ?>" alt="Foto de perfil" style="<?php echo e($fotoPerfil ? '' : 'display:none'); ?>">
          <div class="pf-ava pf-ava-empty" id="pfEmpty" style="display:<?php echo e($fotoPerfil ? 'none' : 'grid'); ?>;place-items:center;color:var(--txt-soft)">
    ...
    <article class="card rise d3">
      ...
      <div class="pf-2">
        <div class="pf-field"><label>Nombre(s)</label><input class="pf-input" type="text" name="name" value="<?php echo e($u->name); ?>"></div>
        <div class="pf-field"><label>Apellido paterno</label><input class="pf-input" type="text" name="apellido_paterno" value="<?php echo e($u->apellido_paterno); ?>"></div>
        <div class="pf-field"><label>Apellido materno</label><input class="pf-input" type="text" name="apellido_materno" value="<?php echo e($u->apellido_materno); ?>"></div>
        <div class="pf-field"><label>Correo electrónico</label><input class="pf-input" type="email" name="email" value="<?php echo e($u->email); ?>"></div>
        <div class="pf-field"><label>Teléfono</label><input class="pf-input" type="tel" name="phone" value="<?php echo e($u->phone); ?>"></div>
        <div class="pf-field"><label>Fecha de nacimiento</label>
          <div class="pf-ico-field">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            <input class="pf-input" type="date" name="fecha_nacimiento" value="<?php echo e($u->fecha_nacimiento ? \Carbon\Carbon::parse($u->fecha_nacimiento)->format('Y-m-d') : ''); ?>">
          </div>
        </div>
      </div>
      <div class="pf-field" style="margin-top:14px;max-width:calc(50% - 7px)">
        ...
        <div class="pf-select">
          <select name="sexo">
            <option <?php echo e($u->sexo === 'Masculino' ? 'selected' : ''); ?>>Masculino</option>
            <option <?php echo e($u->sexo === 'Femenino'  ? 'selected' : ''); ?>>Femenino</option>
            <option <?php echo e($u->sexo === 'Otro'      ? 'selected' : ''); ?>>Otro</option>
          </select>
    ...
    <article class="card rise d4">
      ...
      <div class="pf-field"><label>Especialidad</label><input class="pf-input" type="text" name="specialty" value="<?php echo e($u->specialty); ?>"></div>
      <div class="pf-field"><label>Subespecialidad (opcional)</label><input class="pf-input" type="text" name="subespecialidad" value="<?php echo e($u->subespecialidad); ?>"></div>
      <div class="pf-field"><label>Cédula profesional</label><input class="pf-input" type="text" name="professional_license" value="<?php echo e($u->professional_license); ?>"></div>
      <div class="pf-field"><label>Universidad</label><input class="pf-input" type="text" name="universidad" value="<?php echo e($u->universidad); ?>"></div>
    </article>
  </div>
  ...
  <div class="pf-bottom">
    <article class="card rise d4">
      ...
      <div class="pf-2">
        <div class="pf-field"><label>Nombre de la clínica</label><input class="pf-input" type="text" name="clinica_nombre" value="<?php echo e($u->clinica_nombre); ?>"></div>
        <div class="pf-field"><label>Ciudad</label><input class="pf-input" type="text" name="clinica_ciudad" value="<?php echo e($u->clinica_ciudad); ?>"></div>
        <div class="pf-field"><label>Dirección</label><input class="pf-input" type="text" name="clinica_direccion" value="<?php echo e($u->clinica_direccion); ?>"></div>
        <div class="pf-field"><label>Código postal</label><input class="pf-input" type="text" name="clinica_codigo_postal" value="<?php echo e($u->clinica_codigo_postal); ?>"></div>
        <div class="pf-field"><label>Teléfono de la clínica u hospital</label><input class="pf-input" type="tel" name="clinica_telefono" value="<?php echo e($u->clinica_telefono); ?>"></div>
        <div class="pf-field"><label>Estado</label><input class="pf-input" type="text" name="clinica_estado" value="<?php echo e($u->clinica_estado); ?>"></div>
      </div>
    </article>
    ...
    <article class="card rise d5">
      ...
      <div class="pf-2">
        <div class="pf-field">
          <label>RFC</label>
          <input class="pf-input" id="pfRfc" type="text" name="rfc" maxlength="13" value="<?php echo e($u->rfc); ?>" placeholder="Ingresa tu RFC">
          <div id="pfRfcMsg" class="pf-rfc-msg"></div>
        </div>
        <div class="pf-field"><label>Razón social</label><input class="pf-input" id="pfRazon" type="text" name="razon_social" value="<?php echo e($u->razon_social); ?>"></div>
      </div>
      <div class="pf-field" style="margin-top:14px">
        <label>Régimen fiscal</label>
        <div class="pf-select">
          <select name="regimen_fiscal" id="pfRegimen">
            <option value="" <?php echo e(!$u->regimen_fiscal ? 'selected' : ''); ?>>-- Selecciona tu régimen --</option>
            <option value="601 - General de Ley Personas Morales"                             <?php echo e($u->regimen_fiscal === '601 - General de Ley Personas Morales' ? 'selected' : ''); ?>>601 - General de Ley Personas Morales</option>
            <option value="605 - Sueldos y Salarios e Ingresos Asimilados"                    <?php echo e($u->regimen_fiscal === '605 - Sueldos y Salarios e Ingresos Asimilados' ? 'selected' : ''); ?>>605 - Sueldos y Salarios e Ingresos Asimilados</option>
            <option value="606 - Arrendamiento"                                               <?php echo e($u->regimen_fiscal === '606 - Arrendamiento' ? 'selected' : ''); ?>>606 - Arrendamiento</option>
            <option value="608 - Demás Ingresos"                                              <?php echo e($u->regimen_fiscal === '608 - Demás Ingresos' ? 'selected' : ''); ?>>608 - Demás Ingresos</option>
            <option value="612 - Personas Físicas con Actividades Empresariales y Profesionales" <?php echo e($u->regimen_fiscal === '612 - Personas Físicas con Actividades Empresariales y Profesionales' ? 'selected' : ''); ?>>612 - Personas Físicas con Actividades Empresariales y Profesionales</option>
            <option value="616 - Sin Obligaciones Fiscales"                                   <?php echo e($u->regimen_fiscal === '616 - Sin Obligaciones Fiscales' ? 'selected' : ''); ?>>616 - Sin Obligaciones Fiscales</option>
            <option value="621 - Incorporación Fiscal"                                        <?php echo e($u->regimen_fiscal === '621 - Incorporación Fiscal' ? 'selected' : ''); ?>>621 - Incorporación Fiscal</option>
            <option value="626 - Régimen Simplificado de Confianza (RESICO)"                  <?php echo e($u->regimen_fiscal === '626 - Régimen Simplificado de Confianza (RESICO)' ? 'selected' : ''); ?>>626 - Régimen Simplificado de Confianza (RESICO)</option>
          </select>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
      </div>
      <div class="pf-field"><label>Correo de facturación</label><input class="pf-input" type="email" name="correo_facturacion" value="<?php echo e($u->correo_facturacion); ?>"></div>
      ...
      <div class="pf-field" style="margin-top:18px">
        ...
        <div class="csf-wrap" id="csfWrap">
          ...
          <div id="csfPreview" style="<?php echo e($constancia ? '' : 'display:none'); ?>">
            <?php if($constanciaExt === 'pdf'): ?>
              <div class="csf-pdf-card" id="csfPdfCard">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                <div class="csf-pdf-info">
                  <span id="csfFileName"><?php echo e($constanciaNombre); ?></span>
                  <a href="<?php echo e($constancia); ?>" target="_blank" class="csf-view-link">Ver documento</a>
                </div>
              </div>
            <?php else: ?>
              <img id="csfImg" src="<?php echo e($constancia ?? ''); ?>" alt="Constancia fiscal" style="<?php echo e($constancia ? '' : 'display:none'); ?>">
            <?php endif; ?>
          </div>
          
          <div id="csfUploadArea" class="csf-upload-area" style="<?php echo e($constancia ? 'display:none' : ''); ?>">
          ...
          <div id="csfActions" class="csf-actions" style="<?php echo e($constancia ? '' : 'display:none'); ?>">
...
(function(){
  ...
  saveBtn.addEventListener('click', async function() {
    ...
    try {
      const res = await fetch('<?php echo e(route("configuracion.perfil.update")); ?>', {
        method: 'PATCH',
        headers: {
...
(function(){
  ...
  async function buscarPorRFC(rfc) {
    if (!rfc) return;
    try {
      const res = await fetch('<?php echo e(route("configuracion.rfc.lookup")); ?>', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
(function(){
  ...
  btnUsar.addEventListener('click', async function(){
    ...
    if (fileInput.files && fileInput.files[0]) {
      try {
        ...
        const res = await fetch('<?php echo e(route("configuracion.foto.update")); ?>', {
          method: 'POST',
          body: fd,
  ...
  if (delBtn) delBtn.addEventListener('click', async function(){
    ...
    try {
      await fetch('<?php echo e(route("configuracion.foto.delete")); ?>', {
        method: 'DELETE',
        headers: {
          'X-Requested-With': 'XMLHttpRequest',
          'Accept': 'application/json',
...
(function(){
  ...
  async function uploadFile(file) {
    ...
    try {
      const res  = await fetch('<?php echo e(route("configuracion.constancia.upload")); ?>', {
        method: 'POST', body: fd,
        headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
      });
      const data = await res.json();
  ...
  deleteBtn.addEventListener('click', async function(){
    ...
    try {
      const res  = await fetch('<?php echo e(route("configuracion.constancia.delete")); ?>', {
        method: 'DELETE',
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/sections/perfil.blade.php ENDPATH**/ ?>