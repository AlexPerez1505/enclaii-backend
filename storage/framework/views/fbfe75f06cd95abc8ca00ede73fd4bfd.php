...
<title><?php echo e($anuncio->titulo); ?></title>
<style>
  ...
  .wrapper {
    ...
    border-radius: 16px;
    overflow: hidden;
    border: 2.5px solid <?php echo e($color); ?>;
    box-shadow: 0 0 48px <?php echo e($glow); ?>, 0 0 16px <?php echo e($glow); ?>, 0 0 80px <?php echo e($glow); ?>, inset 0 0 20px rgba(0,0,0,0.4);
  }
  .header {
  ...
  .divider {
    height: 2px;
    background: linear-gradient(90deg, <?php echo e($color); ?>, rgba(255,255,255,0.05), transparent);
    margin: 4px 0 0;
    border-radius: 2px;
    box-shadow: 0 0 8px <?php echo e($glow); ?>;
  }
  .meta {
    margin-top: 10px;
    color: <?php echo e($color); ?>;
  ...
  .body a { color: <?php echo e($color); ?>; text-decoration: underline; }
  ...
  .btn {
    ...
    font-weight: 700;
    border: 2px solid <?php echo e($color); ?>;
    box-shadow: 0 0 12px <?php echo e($glow); ?>;
    letter-spacing: 0.3px;
  }
  .footer {
    padding: 18px 36px;
  ...
  .footer span { color: <?php echo e($color); ?>; font-weight: 600; }
  .brand {
    padding: 20px 36px;
    background: #0D1438;
    ...
    <div class="wrapper">
      <div class="brand">
        ...
        <div class="brand-right">
          <img src="<?php echo e($logoUrl); ?>" alt="Enclaii">
        </div>
      </div>
      <div class="header">
        <div class="badge"><?php echo e($badge); ?></div>
        <h1><?php echo e($anuncio->titulo); ?></h1>
        <div class="divider"></div>
        <div class="meta"><?php echo e(now()->format('d/m/Y')); ?></div>
      </div>
      <div class="body">
      ...
      <div class="btn-wrap">
        <a href="<?php echo e(url('/dashboard')); ?>" class="btn">Ver en la plataforma →</a>
      </div>
      <div class="footer">
        &copy; <?php echo e(date('Y')); ?> <span><?php echo e(config('app.name')); ?></span>. Todos los derechos reservados.<br>
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views\emails\anuncio-publicado.blade.php ENDPATH**/ ?>