  ...
  <div class="sec-top">
    ...
    <article class="card rise d2">
      <div class="cfg-card-head">
        ...
        <p>Tu plan permite <?php echo e($sessionLimit ?? 1); ?> <?php echo e(($sessionLimit ?? 1) === 1 ? 'sesión activa' : 'sesiones activas'); ?> por cuenta. Al superar el límite se cerrará la sesión más antigua.</p>
      </div>
        ...
        <table class="sec-table">
          ...
          <tbody id="secSessionsBody">
            <?php $__empty_1 = true; $__currentLoopData = $connectedSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $connectedSession): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr data-session-row="<?php echo e($connectedSession['type']); ?>-<?php echo e($connectedSession['id']); ?>" data-current-session="<?php echo e($connectedSession['is_current'] ? '1' : '0'); ?>">
                <td>
                  <span class="sec-dev">
                    <?php if($connectedSession['type'] === 'desktop'): ?>
                    ...
                    <?php endif; ?>
                    <span><b><?php echo e($connectedSession['device_label']); ?></b><span><?php echo e($connectedSession['meta']); ?></span></span>
                  </span>
                </td>
                <td><?php echo e($connectedSession['location']); ?></td>
                <td><?php echo e(format_user_date_time($connectedSession['last_activity'])); ?></td>
                <td><span class="sec-on <?php echo e($connectedSession['is_current'] ? 'current' : ''); ?>"><?php echo e($connectedSession['is_current'] ? 'Este dispositivo' : 'Activo'); ?></span></td>
                <td>
                  <button
                    type="button"
                    class="sec-link"
                    data-session-close="<?php echo e($connectedSession['id']); ?>"
                    data-session-url="<?php echo e($connectedSession['close_url']); ?>"
                    <?php if($connectedSession['is_current']): echo 'disabled'; endif; ?>
                  >
                    <?php echo e($connectedSession['is_current'] ? 'Sesión actual' : 'Cerrar sesión'); ?>
      ...
      <div class="sec-foot">
        <button
          ...
          <?php if($connectedSessions->where('is_current', false)->isEmpty()): echo 'disabled'; endif; ?>
        >
    ...
    <article class="card rise d4">
      ...
      <div class="sec-row">
        ...
        <div class="cfg-select">
          <select id="sessionTimeout" data-update-url="<?php echo e(route('configuracion.general.update')); ?>">
            <option value="1" <?php if($timeout == 1): echo 'selected'; endif; ?>>1 minuto</option>
            <option value="30" <?php if($timeout == 30): echo 'selected'; endif; ?>>30 minutos</option>
            <option value="60" <?php if($timeout == 60): echo 'selected'; endif; ?>>60 minutos</option>
            <option value="0"  <?php if($timeout == 0): echo 'selected'; endif; ?>>Nunca</option>
          </select>
