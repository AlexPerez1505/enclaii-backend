...
<div class="tkt-panel" id="panelCrear">
  ...
  <div class="tkt-form-row">
    ...
    <div class="tkt-field">
      ...
      <input type="text" id="tktOperacion" value="<?php echo e($operationData); ?>" readonly placeholder="Folio único, fecha y hora de la compra">
    </div>
  </div>
  ...
  <div class="tkt-form-row full">
    <div class="tkt-field">
      ...
      <input type="text" id="tktNegocio" value="<?php echo e($businessData); ?>" readonly placeholder="Nombre o razón social, domicilio fiscal, RFC">
    </div>
  </div>
...
<div class="tkt-modal-overlay" id="tktPerfilModalOverlay" style="display:none">
  <div class="tkt-modal">
    ...
    <div class="tkt-modal-actions">
      <a href="<?php echo e(route('configuracion')); ?>?tab=perfil" class="tkt-modal-btn mensajes" style="text-decoration:none">Completar perfil →</a>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/soporte/_ticket_form.blade.php ENDPATH**/ ?>