...
<nav class="mobile-nav">
  <a class="mobile-nav-item <?php echo e($active === 'customer-success-dashboard' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.dashboard')); ?>">
  ...
  <a class="mobile-nav-item <?php echo e($active === 'customer-success' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.anuncios')); ?>">
  ...
  <a class="mobile-nav-item <?php echo e($active === 'customer-success-usuarios' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.gestion-usuarios')); ?>">
  ...
  <a class="mobile-nav-item <?php echo e($active === 'customer-success-tickets' ? 'active' : ''); ?>" href="<?php echo e(route('customer-success.tickets')); ?>">
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views-Tec/customer-success/partials/bottom-nav.blade.php ENDPATH**/ ?>