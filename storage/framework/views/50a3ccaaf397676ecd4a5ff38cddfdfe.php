...
<div class="rv-page">
  ...
  <div class="rv-card">
    ...
    <div class="rv-ticket-info" id="ticketInfoToggle">
      <div class="rv-ticket-info-header">
        ...
        <div class="rv-ticket-info-text">
          <div class="rv-ticket-info-title"><?php echo e($ticket->subject); ?></div>
          <div class="rv-ticket-info-meta"><?php echo e($ticket->operation_folio); ?></div>
        </div>
      ...
      <div class="rv-ticket-info-details">
        <div class="rv-ticket-detail-row">
          ...
          <div class="rv-ticket-detail-value"><?php echo e($ticket->user?->name); ?> <?php echo e($ticket->user?->apellido_paterno); ?></div>
        </div>
        <div class="rv-ticket-detail-row">
        ...
        <div class="rv-ticket-detail-row">
          ...
          <div class="rv-ticket-detail-value"><pre><?php echo e($ticket->description); ?></pre></div>
        </div>
        <?php if($ticket->business_name): ?>
        <div class="rv-ticket-detail-row">
          <div class="rv-ticket-detail-label">Negocio</div>
          <div class="rv-ticket-detail-value"><?php echo e($ticket->business_name); ?></div>
        </div>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="rv-resolved-state">
      ...
      <a href="<?php echo e(route('customer-success.tickets')); ?>" class="rv-btn rv-btn-submit">
    ...
    <form id="resolveForm" enctype="multipart/form-data">
      <div class="rv-body">
        ...
        <div class="rv-dropdown" id="resolutionTypeDropdown">
          ...
          <input type="hidden" name="resolution_type" id="resolutionTypeInput" value="<?php echo e($ticket->resolution_type); ?>" required>
        </div>

        <hr class="rv-sep">

        <label class="rv-label">Resumen de la solución</label>
        <textarea name="resolution_summary" class="rv-textarea" placeholder="Describe qué hiciste para resolver el problema..." required><?php echo e($ticket->resolution_summary); ?></textarea>
        ...
        <label class="rv-file-input">
          ...
          <span class="rv-file-name" id="evidenceFileName"><?php echo e($ticket->evidence_path ? basename($ticket->evidence_path) : ''); ?></span>
        </label>
      </div>
  ...
  if(btnSalir){
    btnSalir.addEventListener('click', function(e){
      ...
      if(window.opener){
        ...
        window.location.href = "<?php echo e(route('customer-success.tickets')); ?>";
      }
    });
  }
