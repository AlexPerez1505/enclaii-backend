        ...
        <div class="gen-thumbs" id="genThumbs">
          <?php $__empty_1 = true; $__currentLoopData = $evidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="gen-thumb <?php echo e($i === 0 ? 'sel' : ''); ?>">
              <img src="<?php echo e(asset($ev)); ?>" alt="Evidencia <?php echo e($i + 1); ?>" loading="lazy">
            </div>
...
(function(){
  ...
  const editarUrl = "<?php echo e(route('ia-reportes.editar', ['generating' => 1])); ?>";
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      sessionStorage.setItem('iaReporte', JSON.stringify({
        ...
        imagenes: <?php echo json_encode($evidencias->map(fn ($e) => asset($e))->values(), 15, 512) ?>,
      }));
