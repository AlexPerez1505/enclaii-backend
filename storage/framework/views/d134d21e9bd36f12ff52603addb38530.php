...
<div class="gv-mail-overlay" id="gvMailOverlay" data-send-url="<?php echo e(route('galeria.video.correo.send', $archivo->id, false)); ?>">
  <div class="gv-mail-modal" role="dialog" aria-modal="true" aria-labelledby="gvMailTitle">
    <div class="gv-mail-head">
      <div>
        ...
        <div class="gv-mail-sub"><?php echo e($nombrePaciente); ?> - <?php echo e($folioEstudio); ?></div>
      </div>
    ...
    <form class="gv-mail-form" id="gvMailForm">
      ...
      <div class="gv-mail-field">
        ...
        <input id="gvMailRecipients" name="recipients" type="text" value="<?php echo e($galleryEmailDefaultRecipient); ?>" placeholder="correo@ejemplo.com" autocomplete="email">
        <span>Hasta 10 correos separados por coma.</span>
      </div>

      <div class="gv-mail-field">
        <label for="gvMailSubject">Asunto</label>
        <input id="gvMailSubject" name="subject" type="text" value="<?php echo e($galleryEmailSubject); ?>" maxlength="180">
      </div>

      <div class="gv-mail-field">
        <label for="gvMailMessage">Mensaje</label>
        <textarea id="gvMailMessage" name="message" rows="6" maxlength="5000"><?php echo e($galleryEmailMessage); ?></textarea>
      </div>
...
(function(){
  ...
  const csrfToken = form?.querySelector('input[name="_token"]')?.value
    ...
    || <?php echo json_encode(csrf_token(), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/galeria/_video_email_modal.blade.php ENDPATH**/ ?>