...
<div class="rise d2">
  ...
  <div class="ev-topbar">
    ...
    <a href="<?php echo e(route('galeria.video', $id)); ?>" class="ev-btn cancel">Cancelar</a>
    <button class="ev-btn more">···</button>
    <a href="<?php echo e(route('galeria')); ?>" class="ev-btn close">
    ...
    <div>
      ...
      <div>
        ...
        <div class="ev-caps-strip">
          ...
          <div class="ev-cap-item <?php echo e($i===1 ? 'sel' : ''); ?>" data-ts="<?php echo e($c['ts']); ?>">
            <div class="ev-cap-thumb" style="background:<?php echo e($bgs[$i]); ?>">
              ...
              <span class="ev-cap-num"><?php echo e($c['n']); ?></span>
            ...
            <div class="ev-cap-ts"><?php echo e($c['ts']); ?></div>
          </div>
