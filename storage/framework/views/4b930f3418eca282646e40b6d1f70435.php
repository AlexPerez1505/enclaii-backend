...
<?php
  ...
  $mostrarFinalizado = request()->query('vista') === 'finalizado';
?>
<div class="studio-wrap" <?php if($mostrarFinalizado): ?> style="display:none" <?php endif; ?>>
      ...
      <div class="studio-timeline">
        ...
        <div class="studio-tl-scroll" id="recTimeline">
          ...
          <div class="studio-thumb" data-id="<?php echo e($cap->id); ?>">
            ...
            <span class="studio-thumb-time"><?php echo e(format_user_time_with_seconds($cap->capturado_en)); ?></span>
          </div>
...
<div class="studio-finalizado-wrap<?php echo e($mostrarFinalizado ? ' active' : ''); ?>" id="studioFinalizado">
      ...
      <div>
        ...
        <div class="studio-final-caps-strip" id="sfCapsStrip">
          ...
          <div class="studio-final-cap-item <?php echo e($i===0 ? 'sel' : ''); ?>" data-id="<?php echo e($cap->id); ?>">
            ...
            <div class="studio-final-cap-ts"><?php echo e(format_user_time_with_seconds($cap->capturado_en)); ?></div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
(function () {
  ...
  const CAPTURAS_URL = <?php echo json_encode(route('nuevo-estudio.capturas.store'), 15, 512) ?>;
  const FINALIZAR_URL = <?php echo json_encode(route('nuevo-estudio.finalizar'), 15, 512) ?>;
  const GALERIA_URL = <?php echo json_encode($estudio?->paciente_id ? route('galeria.paciente', $estudio->paciente_id) : route('galeria'), 512) ?>;
  const MOSTRAR_FINALIZADO = <?php echo json_encode($mostrarFinalizado, 15, 512) ?>;
  ...
  let secs = 0, paused = false, fotos = <?php echo e($numCapturas); ?>, clips = 0;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\estudios\grabando.blade.php ENDPATH**/ ?>