  ...
  <div class="cat-hospital-card">
    ...
    <div class="cat-panels">
      <div id="catalog-panel-personal" class="cat-panel">
        <?php echo $__env->make('configuracion.sections.integraciones.__Int_hospital_catalog.__personal.__personal_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>
      <div id="catalog-panel-procedimientos" class="cat-panel hidden">
        <?php echo $__env->make('configuracion.sections.integraciones.__Int_hospital_catalog.__process.__process_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/sections/integraciones/__Int_hospital_catalog/hospital_catlog_index.blade.php ENDPATH**/ ?>