<?php $gen = request()->boolean('generating'); ?>

<?php $__env->startSection('title', $gen ? 'IA Generando Informe' : 'Crear Nuevo Informe'); ?>
<?php $__env->startSection('active', 'ia-reportes'); ?>
<?php $__env->startSection('header-title', $gen ? 'IA Generando Informe' : 'Crear Nuevo Informe'); ?>
<?php $__env->startSection('header-sub'); ?>
  <?php echo e($gen ? 'La IA está redactando y estructurando el informe' : 'Edita y personaliza el informe del estudio'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="ed-actions">
    <a class="ed-btn" href="<?php echo e(route('ia-reportes.todos')); ?>">
  ...
  <div class="ed-body">
   ...
   <div class="ed-main">
    ...
    <article class="card ed-doc rise d2 <?php echo e($gen ? 'is-generating' : ''); ?>">
      <div class="doc-h">
      ...
      <h4>INDICACIÓN <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <p>Dolor abdominal epigástrico, náusea y pirosis.</p>

      <h4>SEDACIÓN <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <p>Sedación consciente con midazolam y fentanilo.</p>

      <h4>HALLAZGOS <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <ul>
      ...
      <h4>IMPRESIÓN DIAGNÓSTICA <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <p>Gastritis antral leve.</p>

      <h4>PLAN Y RECOMENDACIONES <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <ul>
        <li>Omeprazol 20 mg cada 24 horas por 8 semanas.</li>
        <li>Dieta y medidas generales.</li>
      </ul>

      <h4>OBSERVACIONES <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
      <p>Se toman biopsias de antro para estudio histopatológico y detección de Helicobacter pylori.</p>

      <h4>ANEXOS <?php if($gen): ?><span class="sec-st wait">Pendiente</span><?php endif; ?></h4>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\ia-reportes\editar.blade.php ENDPATH**/ ?>