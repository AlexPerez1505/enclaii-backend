...
<title>Restablecer contraseña — ENCLAII</title>
...
.ec-input{
  width:100%;height:54px;padding:0 48px 0 16px;font:inherit;font-size:15px;
...
.ec-input[readonly]{opacity:.65;cursor:not-allowed}
...
.ec-eye{
  ...
  background:none;border:0;cursor:pointer;color:#8C99BC;border-radius:10px;
  transition:color 150ms ease,transform 160ms var(--ease-out),background 150ms ease;
}
.ec-eye:active{transform:scale(.92)}
@media(hover:hover) and (pointer:fine){.ec-eye:hover{color:var(--blue-500);background:rgba(46,123,246,.08)}}
.ec-error{
...
<div class="ec-shell">
  ...
  <div class="ec-form-panel">
    <div class="ec-stagger">
      <div class="ec-brand">
        <img src="<?php echo e(asset('img/enclaii-logo.svg')); ?>" alt="Enclaii" onerror="this.style.display='none'">
    ...
    <div class="ec-stagger">
      <h1 class="ec-title">Restablecer contraseña</h1>
      <p class="ec-subtitle">Ingresa tu nueva contraseña para continuar.</p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('password.update')); ?>" id="resetForm" class="ec-stagger">
      <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
          <div class="ec-error"><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
      ...
      <div class="ec-field">
        <label class="ec-label" for="password">Nueva contraseña</label>
        <div class="ec-input-wrap">
          <input
...
unset($__errorArgs, $__bag); ?>"
            ...
            required
          >
          <button type="button" class="ec-eye" data-toggle="password">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="ec-field">
        ...
        <div class="ec-input-wrap">
          <input
            ...
            required
          >
          <button type="button" class="ec-eye" data-toggle="password_confirmation">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
      </div>
      ...
      <button class="ec-btn" type="submit" id="submitBtn">
        <span class="ec-btn-content">Restablecer contraseña</span>
    ...
    <div class="ec-stagger">
      <a href="<?php echo e(route('login')); ?>" class="ec-back-link">
  ...
  <div class="ec-visual" aria-hidden="true">
    ...
    <div class="ec-visual-label">
      ...
      Elige una contraseña segura para proteger tu cuenta y tu información médica.
    </div>
  </div>
...
document.getElementById('resetForm').addEventListener('submit', function(){
  document.getElementById('submitBtn').setAttribute('data-loading', 'true');
});
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>