...
<?php $__env->startSection('header-title', 'Tickets de soporte'); ?>
<?php $__env->startSection('header-sub', 'Tickets creados por usuarios.'); ?>
  ...
  <div class="tk-stats">
    <div class="tk-stat">
      ...
      <div class="tk-stat-info">
        ...
        <div class="tk-stat-value"><?php echo e($stats['total']); ?></div>
      </div>
    </div>
    <div class="tk-stat">
      <div class="tk-stat-icon">
      ...
      <div class="tk-stat-info">
        ...
        <div class="tk-stat-value"><?php echo e($stats['nuevos']); ?></div>
      </div>
    </div>
    <div class="tk-stat">
      <div class="tk-stat-icon">
      ...
      <div class="tk-stat-info">
        ...
        <div class="tk-stat-value"><?php echo e($stats['en_curso']); ?></div>
      </div>
    </div>
    <div class="tk-stat">
      <div class="tk-stat-icon">
      ...
      <div class="tk-stat-info">
        ...
        <div class="tk-stat-value"><?php echo e($stats['cerrados']); ?></div>
      </div>
    </div>
  </div>
    ...
    <?php else: ?>
      <table class="tk-table" id="ticketsTable">
        ...
        <tbody>
          ...
          <tr data-status="<?php echo e($ticket->status); ?>" data-category="<?php echo e($ticket->category); ?>">
            <td data-label="Folio"><span class="tk-folio"><?php echo e($ticket->operation_folio); ?></span></td>
            <td data-label="Usuario">
              <div class="tk-user">
                <div class="tk-avatar"><?php echo e(mb_strtoupper(mb_substr($ticket->user?->name ?? '?', 0, 2))); ?></div>
                <div class="tk-user-info">
                  <div class="tk-user-name"><?php echo e($ticket->user?->name); ?> <?php echo e($ticket->user?->apellido_paterno); ?></div>
                  <div class="tk-user-email"><?php echo e($ticket->user?->email); ?></div>
                </div>
              </div>
            </td>
            ...
            <td data-label="Asunto"><div class="tk-asunto"><?php echo e($ticket->subject); ?></div></td>
            <td data-label="Estado">
              <span class="tk-estado <?php echo e($ticket->status); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $ticket->status))); ?></span>
            </td>
            <td data-label="Fecha">
              <span class="tk-fecha">
            ...
            <td data-label="Acciones">
              <a href="<?php echo e(route('customer-success.tickets.show', $ticket)); ?>" class="tk-btn tk-btn-ghost">
...
(function(){
  ...
  var pollUrl = "<?php echo e(route('customer-success.api.tickets.poll')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views-Tec/customer-success/tickets/index.blade.php ENDPATH**/ ?>