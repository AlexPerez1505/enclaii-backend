...
<div class="ec-shell">
  ...
  <div class="ec-form-panel">
    ...
    <form method="POST" action="<?php echo e(route('password.email')); ?>" id="forgotForm" class="ec-stagger">
      <?php echo csrf_field(); ?>
      <div class="ec-field">
...
<?php /**PATH C:\Users\HP\enclaii-backend\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>