...
(function(){
  ...
  const citasBackend = <?php echo json_encode($citasAgenda ?? [], 15, 512) ?>;
  const EVENTS = {};
  ...
  <?php if(isset($bloqueosData) && !empty($bloqueosData)): ?>
  const bloqueosBackend = <?php echo json_encode($bloqueosData, 15, 512) ?>;
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/agenda/_events.blade.php ENDPATH**/ ?>