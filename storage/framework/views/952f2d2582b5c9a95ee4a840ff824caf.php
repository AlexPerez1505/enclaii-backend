...
<div class="vv-topbar">
  <a href="<?php echo e(route('galeria.paciente', $pacienteId)); ?>" class="vv-btn cancel">
  ...
  <a href="<?php echo e(route('galeria.video.editar', ['id' => $id, 'paciente' => $pacienteId])); ?>" class="vv-btn edit">
