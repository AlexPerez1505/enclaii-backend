    ...
    <div class="gen-col-left">
        ...
        <div class="gen-thumbs" id="genThumbs">
          <?php $__empty_1 = true; $__currentLoopData = $evidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="gen-thumb <?php echo e($i === 0 ? 'sel' : ''); ?>">
              <img src="<?php echo e($ev); ?>" alt="Evidencia <?php echo e($i + 1); ?>" loading="lazy">
            </div>
      ...
      <div class="step rise d6">
        ...
        <div class="gen-checks" id="genOpts">
          <label class="gen-check"><input type="checkbox" data-opt="Analizar imágenes" <?php if($userSettings['ai_analyze_photos'] ?? true): echo 'checked'; endif; ?>> Analizar imágenes</label>
          <label class="gen-check"><input type="checkbox" data-opt="Generar recomendaciones" <?php if($userSettings['ai_recommend_procedures'] ?? true): echo 'checked'; endif; ?>> Generar recomendaciones</label>
          ...
          <label class="gen-check"><input type="checkbox" data-opt="Detectar patologías" <?php if($userSettings['ai_suggest_diagnoses'] ?? true): echo 'checked'; endif; ?>> Detectar patologías</label>
...
(function(){
  ...
  btn.addEventListener('click', async () => {
    ...
    const payload = {
      ...
      opciones,
      imagenes: <?php echo json_encode($evidencias, 15, 512) ?>,
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views/ia-reportes/generar.blade.php ENDPATH**/ ?>