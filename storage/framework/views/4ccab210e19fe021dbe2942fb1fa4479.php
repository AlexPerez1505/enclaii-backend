  ...
  <div class="tk-col">
    ...
    <div class="tk-card tk-card-glow">
      ...
      <div class="tk-resolved-banner">
        ...
        <a href="<?php echo e(route('customer-success.tickets')); ?>" class="tk-reopen-btn" style="margin-top:0;flex-shrink:0">
      ...
      <div class="tk-card-body">
        <div class="tk-field">
          ...
          <div class="tk-priority-list" role="group" aria-label="Prioridad del ticket">
            <button type="button" class="tk-priority-option baja <?php echo e($ticket->priority === 'baja' ? 'active' : ''); ?>" data-priority="baja">Baja</button>
            <button type="button" class="tk-priority-option media <?php echo e($ticket->priority === 'media' ? 'active' : ''); ?>" data-priority="media">Media</button>
            <button type="button" class="tk-priority-option alta <?php echo e($ticket->priority === 'alta' ? 'active' : ''); ?>" data-priority="alta">Alta</button>
            <button type="button" class="tk-priority-option urgente <?php echo e($ticket->priority === 'urgente' ? 'active' : ''); ?>" data-priority="urgente">Urgente</button>
          </div>
        </div>
