<?php $__env->startSection('title', 'Estudio Finalizado'); ?>
  ...
  <div class="studio-finalizado-main">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;overflow:hidden">
      ...
      <div class="studio-final-actions">
        <a class="studio-final-act-btn guardar" href="<?php echo e($galeria_url); ?>" style="background:rgba(34,197,94,.14);border-color:rgba(34,197,94,.4);color:#22c55e">
        ...
        <div class="sf-share-wrap" style="position:relative">
          ...
          <div class="sf-share-dropdown" id="sfShareDropdown">
            <a class="sf-share-item" href="<?php echo e(route('mensajes', ['desde' => 'estudio_terminado', 'estudio_id' => $estudio?->id, 'paciente' => $estudio?->paciente_id, 'estudio' => $estudio?->id])); ?>" target="_blank">
            ...
            <a class="sf-share-item" href="mailto:?subject=Estudio+<?php echo e(urlencode($estudio?->folio ?? '')); ?>&body=Adjunto+resultados+del+estudio+<?php echo e(urlencode($pacienteNombre)); ?>.">
            ...
            <?php if($estudio?->video_path): ?>
            <a class="sf-share-item" href="<?php echo e(media_url($estudio->video_path)); ?>" download="estudio_<?php echo e($estudio->folio ?? $estudio->id); ?>.<?php echo e(pathinfo($estudio->video_path, PATHINFO_EXTENSION)); ?>">
        ...
        <a class="studio-final-act-btn" style="background:rgba(56,199,244,.14);border-color:rgba(56,199,244,.4);color:#38c7f4" href="<?php echo e(route('ia-reportes.generar', ['estudio' => $estudio?->id])); ?>">
        ...
        <a class="studio-final-act-btn fin" href="<?php echo e(route('ia-reportes.redactar', ['paciente' => $estudio?->paciente_id, 'estudio' => $estudio?->id])); ?>">
      ...
      <div>
        ...
        <div class="studio-final-caps-strip" id="sfCapsStrip">
          ...
          <div class="studio-final-cap-item <?php echo e($i===0 ? 'sel' : ''); ?>" data-id="<?php echo e($cap->id); ?>">
            ...
            ?>
            <div class="studio-final-cap-ts"><?php echo e($ts); ?></div>
          </div>
      ...
      <div class="studio-resumen-card">
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value">
            <?php if($estudio?->duracion_segundos): ?><?php echo e(gmdate('H:i:s', $estudio->duracion_segundos)); ?><?php else: ?>--:--:--<?php endif; ?>
          </div>
        </div>
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value"><?php echo e($capturas->count()); ?></div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\estudios\finalizado\index.blade.php ENDPATH**/ ?>