...
.desktop-app-head p{font-size:13px;color:var(--txt-soft);margin:3px 0 18px}
.desktop-app-stack{display:flex;flex-direction:column;gap:18px;max-width:920px}
.desktop-app-card{padding:22px}
...
.desktop-app-copy{font-size:13px;color:var(--txt);line-height:1.55;margin-top:32px;max-width:760px}
.desktop-app-download{display:flex;align-items:center;justify-content:space-between;gap:18px;width:100%;padding:22px 26px;color:var(--txt);transition:background-color .15s,transform .15s}
.desktop-app-download:active{transform:scale(.99)}
@media (hover:hover){.desktop-app-download:hover{background:rgba(56,199,244,.07)}}
.desktop-app-download-main{display:flex;flex-direction:column;gap:10px;min-width:0}
...
.desktop-app-requirements{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:10px}
.desktop-app-requirements li{font-size:13px;color:var(--txt);line-height:1.35}
@media (max-width:620px){
  .desktop-app-card{padding:18px}
  .desktop-app-copy{margin-top:22px}
  .desktop-app-download{padding:18px;align-items:flex-start}
...
<div class="cfg-panel" data-panel="aplicacion-escritorio">
  ...
  <div class="desktop-app-stack">
    ...
    <article class="card desktop-app-card compact rise d3">
      <a class="desktop-app-download" href="<?php echo e(route('desktop-app.download')); ?>">
        <span class="desktop-app-download-main">
          <span class="desktop-app-download-title">Descargar para Windows</span>
          <span class="desktop-app-download-meta">Versión <?php echo e($desktopAppVersion); ?> &bull; <?php echo e($desktopAppArchitecture); ?></span>
        </span>
    ...
    <article class="card desktop-app-card rise d4">
      ...
      <ul class="desktop-app-requirements">
        ...
        <li>8 GB de RAM</li>
        <li>500 MB de almacenamiento</li>
