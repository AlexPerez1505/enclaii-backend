        ...
        <section class="desktop-app-downloads">
          ...
          <div class="desktop-download-grid">
            <article class="desktop-download-card">
              ...
              <div>
                <div class="desktop-download-title">Windows <span class="desktop-version-pill">v<?php echo e($desktopAppVersion); ?></span></div>
                <div class="desktop-download-meta"><?php echo e($desktopAppArchitecture); ?> &bull; Instalador EXE recomendado</div>
                <a class="desktop-download-btn" href="<?php echo e(route('desktop-app.download')); ?>">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="desktop-download-size">Tamaño: <?php echo e($desktopAppSize); ?></div>
              </div>
            </article>
            ...
            <article class="desktop-download-card">
              ...
              <div>
                <div class="desktop-download-title">macOS <span class="desktop-version-pill">v<?php echo e($desktopMacVersion); ?></span></div>
                <div class="desktop-download-meta"><?php echo e($desktopMacArchitecture); ?> &bull; DMG con ENCLAII Desktop.app</div>
                <a class="desktop-download-btn" href="<?php echo e(route('desktop-app.download.mac')); ?>">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                    <path d="M7 10l5 5 5-5"/>
                    <path d="M12 15V3"/>
                ...
                <div class="desktop-download-size">Tamaño: <?php echo e($desktopMacSize); ?></div>
              </div>
            </article>
          </div>
        </section>
    ...
    <aside class="desktop-app-side">
      ...
      <article class="card desktop-side-card rise d4">
        <div class="desktop-side-title">
          ...
          <span class="desktop-version-pill">Win v<?php echo e($desktopAppVersion); ?> / Mac v<?php echo e($desktopMacVersion); ?></span>
        </div>
      ...
      <a class="card desktop-side-card desktop-guide rise d5" href="<?php echo e($desktopAppManualUrl); ?>" target="_blank" rel="noopener" aria-label="Abrir manual de instalación de ENCLAII Endoscopy">
        <div>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/sections/aplicacion-escritorio.blade.php ENDPATH**/ ?>