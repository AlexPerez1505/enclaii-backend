<?php $__env->startSection('title', 'Ver Informe'); ?>
<?php $__env->startSection('active', 'ia-reportes'); ?>
<?php $__env->startSection('header-title', 'Informe de ' . ($reporte?->estudio?->tipo ?? 'Endoscopia')); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="vw-actions">
    <a class="vw-btn" href="<?php echo e(route('ia-reportes.todos')); ?>">
  ...
  <div class="vw-status">
    ...
    <span>Generado el <?php echo e(format_user_date_time($reporte?->created_at) ?: '—'); ?></span>
  </div>
  ...
  <article class="card vw-doc rise d2">
    ...
    <div class="doc-h">
      <h2><?php echo e($tituloPlantilla); ?></h2>
      <p><?php echo e($subPlantilla); ?></p>
    </div>

    <div class="doc-meta">
      <span class="k">Paciente:</span><span><?php echo e($nombrePaciente); ?></span>
      <span class="k">Fecha de nacimiento:</span><span><?php echo e(format_user_date($paciente?->fecha_nacimiento) ?: '—'); ?></span>
      <span class="k">Edad:</span><span><?php echo e($paciente?->edad ?? '—'); ?> años</span>
      <span class="k">Médico solicitante:</span><span><?php echo e($medicoNombre); ?></span>
      <span class="k">Fecha del estudio:</span><span><?php echo e($fechaEstudio); ?> <?php echo e($horaEstudio); ?></span>
      <span class="k">Endoscopista:</span><span><?php echo e($medicoNombre); ?></span>
      <span class="k">Tipo de estudio:</span><span><?php echo e($tipoEstudio); ?></span>
    </div>
    ...
    <?php if($imgCount): ?>
      <div class="rep-imgs" style="<?php echo e($repImgsStyle); ?>">
        <?php $__currentLoopData = $imagenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="cell" style="background:none;overflow:hidden">
            <img src="<?php echo e($url); ?>" alt="" style="width:100%;height:100%;object-fit:cover;display:block">
          </span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    <?php endif; ?>

    <div class="doc-content <?php if(!$contenidoHtml): ?> pre <?php endif; ?>">
      <?php if($contenidoHtml): ?>
        <?php echo $contenidoHtml; ?>

      <?php else: ?>
        <?php echo nl2br(e($contenidoTexto)); ?>
    ...
    <div class="rep-sign" data-pos="center">
      <div class="sign-box">
        <?php if($firmaImagen): ?>
          <img class="sign-image" src="<?php echo e($firmaImagen); ?>" alt="Firma digital de <?php echo e($firmaNombre); ?>">
        <?php endif; ?>
        <div class="sign-line">
          <div class="nm"><?php echo e($firmaNombre); ?></div>
        </div>
      </div>
    </div>
  </article>
  ...
  <script>
    (function() {
      const cfg = <?php echo json_encode($cfg, 15, 512) ?>;
      ...
      if (repAnat) {
        const tipo = '<?php echo e(ucfirst(strtolower($tipoEstudio))); ?>';
        const STUDY_IMG = {
    ...
    (function() {
      ...
      window.downloadPdf = () => {
        ...
        const opt = {
          ...
          filename: 'Informe_<?php echo e(\Illuminate\Support\Str::replace(' ', '_', $nombrePaciente)); ?>_<?php echo e($fechaEstudio); ?>.pdf',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\ia-reportes\ver.blade.php ENDPATH**/ ?>