...
<title><?php echo $__env->yieldContent('title', 'Selecciona tu plan'); ?> — ENCLAII</title>
...
<div class="po-wrap">
  <div class="po-header">
    <div class="po-logo">
      <img src="<?php echo e(asset('images/logo-dark.png')); ?>" alt="ENCLAII">
      <div class="po-brand">ENCLA<span>II</span></div>
    </div>
    <h1 class="po-title"><?php echo $__env->yieldContent('po-title', 'Selecciona tu plan'); ?></h1>
    <p class="po-sub"><?php echo $__env->yieldContent('po-sub', 'Elige el plan que mejor se adapte a tus necesidades para comenzar a usar EndoCare.'); ?></p>
    <?php if(session('warning')): ?>
      <div class="po-alert"><?php echo e(session('warning')); ?></div>
    <?php endif; ?>
    <?php if(session('info')): ?>
      <div class="po-alert info"><?php echo e(session('info')); ?></div>
    <?php endif; ?>
    <?php if(session('success')): ?>
      <div class="po-alert success"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
      <div class="po-alert error"><?php echo e(session('error')); ?></div>
    <?php endif; ?>
  </div>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/layouts/plan-only.blade.php ENDPATH**/ ?>