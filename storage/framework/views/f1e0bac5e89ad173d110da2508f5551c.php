          ...
          <div class="desktop-download-grid">
            <article class="desktop-download-card">
              ...
              <div>
                ...
                <div class="desktop-download-meta"><?php echo e($desktopAppArchitecture); ?> &bull; Instalador MSI recomendado</div>
    ...
    <aside class="desktop-app-side">
      ...
      <article class="card desktop-side-card rise d4">
        <div class="desktop-side-title">
          ...
          <span class="desktop-version-pill">v<?php echo e($desktopAppVersion); ?></span>
        </div>
