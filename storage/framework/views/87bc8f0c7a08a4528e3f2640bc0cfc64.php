<?php $__env->startSection('title', 'Nuevo Estudio/Grabando'); ?>
...
<?php echo $__env->make('estudios.grabando.grabando-css', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
    ...
    <div class="studio-top-left">
      <div class="studio-rec-status">
        ...
        <div>
          ...
          <div class="studio-study-name">Estudio: <?php echo e($estudio?->tipo ?? 'Sin tipo'); ?> <?php if($estudio?->folio): ?> · <?php echo e($estudio->folio); ?> <?php endif; ?></div>
        </div>
      </div>
    </div>
    ...
    <div class="studio-top-right">
      ...
      <div class="studio-top-group">
        ...
        <div class="studio-doctor">
          <div class="studio-doc-avatar"><?php echo e($studioUserInitials); ?></div>
          <div class="studio-doc-info">
            <div class="studio-doc-name"><?php echo e($studioUserName); ?></div>
  ...
  <div class="studio-main">
    ...
    <div class="studio-center">
      ...
      <div class="studio-timeline">
        ...
        <div class="studio-tl-scroll" id="recTimeline">
          <?php $__empty_1 = true; $__currentLoopData = $capturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="studio-thumb" data-id="<?php echo e($cap->id); ?>">
            <div class="studio-thumb-inner" style="padding:0;overflow:hidden">
              <img src="<?php echo e(media_url($cap->path)); ?>" alt="captura" style="width:100%;height:100%;object-fit:cover;border-radius:8px">
            </div>
            <?php $tsTl = is_numeric($cap->descripcion) ? gmdate('H:i:s',(int)$cap->descripcion) : (optional($cap->capturado_en)->format('H:i:s') ?? ''); ?>
            <span class="studio-thumb-time"><?php echo e($tsTl); ?></span>
          </div>
      ...
      <div class="studio-bottom">
        ...
        <div class="studio-rec-controls">
          ...
          <a class="studio-terminar-btn" href="<?php echo e(route('nuevo-estudio')); ?>">
    ...
    <div class="studio-sidebar">
      ...
      <div class="studio-stats">
        <div class="studio-stat-card studio-stat-card-hover" title="Paciente: <?php echo e($pacienteNombre); ?>">
        ...
        <div class="studio-stat-card">
          ...
          <div class="studio-stat-value" id="recFotos"><?php echo e($numCapturas); ?></div>
        </div>
      </div>
      ...
      <div class="studio-sidebar-actions">
        ...
        <a class="studio-btn-volver" href="<?php echo e(route('nuevo-estudio')); ?>">
  ...
  <div class="studio-finalizado-main">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;overflow:hidden">
      ...
      <div class="sf-video-player" style="flex:1">
        ...
        <video id="sfVideoEl" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;background:#000;z-index:1;display:block" preload="metadata"<?php if($estudio?->video_path): ?> src="<?php echo e(media_url($estudio->video_path)); ?>"<?php endif; ?>></video>
      ...
      <div class="studio-final-actions">
        ...
        <div class="sf-share-wrap" style="position:relative">
          ...
          <div class="sf-share-dropdown" id="sfShareDropdown">
            <a class="sf-share-item" id="sfShareWa" href="<?php echo e(route('mensajes', ['desde' => 'estudio_terminado', 'estudio_id' => $estudio?->id, 'paciente' => $estudio?->paciente_id, 'estudio' => $estudio?->id])); ?>" target="_blank">
            ...
            <a class="sf-share-item" id="sfShareEmail" href="mailto:?subject=Estudio+<?php echo e(urlencode($estudio?->folio ?? '')); ?>&body=Adjunto+resultados+del+estudio+<?php echo e(urlencode($pacienteNombre)); ?>.">
        ...
        <a class="studio-final-act-btn" style="background:rgba(56,199,244,.14);border-color:rgba(56,199,244,.4);color:#38c7f4" href="<?php echo e(route('ia-reportes.generar', ['estudio' => $estudio?->id])); ?>"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M12 18v-6"/><path d="M9 15l3 3 3-3"/></svg>Generar reporte IA</a>
        <a class="studio-final-act-btn fin" href="<?php echo e(route('ia-reportes.redactar', ['paciente' => $estudio?->paciente_id, 'estudio' => $estudio?->id])); ?>"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"/></svg>Finalizar estudio</a>
      </div>
      ...
      <div>
        ...
        <div class="studio-final-caps-strip" id="sfCapsStrip">
          ...
          <div class="studio-final-cap-item <?php echo e($i===0 ? 'sel' : ''); ?>" data-id="<?php echo e($cap->id); ?>">
            <div class="studio-final-cap-thumb">
              <img src="<?php echo e(media_url($cap->path)); ?>" alt="captura" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
              <span class="studio-final-cap-num"><?php echo e($i+1); ?></span>
            ...
            <?php $tsCap = is_numeric($cap->descripcion) ? gmdate('H:i:s',(int)$cap->descripcion) : (optional($cap->capturado_en)->format('H:i:s') ?? ''); ?>
            <div class="studio-final-cap-ts"><?php echo e($tsCap); ?></div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
      ...
      <div class="studio-resumen-card">
        ...
        <div class="studio-resumen-item">
          <div class="studio-resumen-label">
            <div class="studio-resumen-icon studio-icon-paciente" data-paciente="<?php echo e($pacienteNombre); ?>">
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value" id="sfResumenDuracion"><?php if($estudio?->duracion_segundos): ?><?php echo e(gmdate('H:i:s', $estudio->duracion_segundos)); ?><?php else: ?>--:--:--<?php endif; ?></div>
        </div>
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value"><?php echo e(optional($estudio?->fecha)->format('d/m/Y') ?? now()->format('d/m/Y')); ?></div>
        </div>
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value"><?php echo e($studioUserName); ?></div>
        </div>
        ...
        <div class="studio-resumen-item">
          ...
          <div class="studio-resumen-value" id="sfResumenFotos"><?php echo e($numCapturas); ?></div>
        </div>
  ...
  <div class="studio-finalizado-main">
    ...
    <div style="display:flex;flex-direction:column;gap:16px;overflow:hidden">
      ...
      <div>
        ...
        <div class="studio-final-caps-strip">
          ...
          ?>
          <?php $__currentLoopData = $capsEm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="studio-final-cap-item <?php echo e($i===1 ? 'sel' : ''); ?>" data-ts="<?php echo e($c['ts']); ?>">
            <div class="studio-final-cap-thumb">
              ...
              <span class="studio-final-cap-num"><?php echo e($c['n']); ?></span>
              <span class="studio-final-cap-check"><svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="3" stroke-linecap="round"><polyline points="20 6 9 17 4 12"/></svg></span>
            </div>
            <div class="studio-final-cap-ts"><?php echo e($c['ts']); ?></div>
          </div>
    ...
    <div class="studio-resumen-sidebar">
      ...
      <div class="studio-resumen-card">
        ...
        <div class="studio-resumen-item">
          <div class="studio-resumen-label">
            <div class="studio-resumen-icon studio-icon-paciente" data-paciente="<?php echo e($pacienteNombre); ?>"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
            Estado
          </div>
...
<?php echo $__env->make('estudios.grabando.grabando-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\enclaii-backend\resources\views\estudios\grabando\index.blade.php ENDPATH**/ ?>