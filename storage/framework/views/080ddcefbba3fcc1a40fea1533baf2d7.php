...
<div>
  ...
  <div class="vv-actions">
    ...
    <a class="vv-act-btn wa" href="<?php echo e(route('mensajes', [
      'canal' => 'whatsapp',
  ...
  <div>
    ...
    <div class="vv-caps-strip" id="vvStrip">
      ...
      <div class="vv-cap-item <?php echo e($i === 1 ? 'sel' : ''); ?>" data-ts="<?php echo e($c['ts']); ?>">
        <div class="vv-cap-thumb" style="background:<?php echo e($bgs[$i]); ?>">
          ...
          <span class="vv-cap-num"><?php echo e($c['n']); ?></span>
        ...
        <div class="vv-cap-ts"><?php echo e($c['ts']); ?></div>
      </div>
