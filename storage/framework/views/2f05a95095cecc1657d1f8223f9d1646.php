    ...
    <div class="cfg-col">
      ...
      <article class="card rise d4">
        ...
        <?php if(auth()->user()->esVeterinaria()): ?>
          <div class="pl-card <?php echo e($currentPlan === 'clinica_veterinaria' ? 'current' : ''); ?>" data-card="clinica_veterinaria">
            <div class="pc-top">
              <span class="pc-ico" style="color:var(--green)"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('maki-veterinary'); ?>
...
<?php endif; ?></span>
              <?php if($currentPlan === 'clinica_veterinaria'): ?>
                <span class="pc-badge">Plan actual</span>
              <?php endif; ?>
            </div>
            <h4><?php echo e($storagePlans['clinica_veterinaria']['label']); ?></h4><div class="pc-gb"><?php echo e($fmtGb($storagePlans['clinica_veterinaria']['gb_per_person'])); ?> por persona</div>
            <div class="pc-gb"><?php echo e($fmtGb($storagePlans['clinica_veterinaria']['total_gb_for_current_people'])); ?> para <?php echo e($storageSummary['person_count']); ?> <?php echo e($storageSummary['person_count'] === 1 ? 'persona activa' : 'personas activas'); ?></div>
            <ul class="pc-feat">
            ...
            <a href="#" class="pc-cta <?php echo e($currentPlan === 'clinica_veterinaria' || !$isClinicOwner ? 'disabled' : ''); ?>" data-plan="clinica_veterinaria" data-interval="month">
              <?php echo e($currentPlan === 'clinica_veterinaria' ? 'Plan actual' : ($isClinicOwner ? 'Cambiar a Clínica Veterinaria' : 'Solo el propietario')); ?>

            </a>
          </div>

          <div class="pl-card <?php echo e($currentPlan === 'hospital_veterinario' ? 'current' : ''); ?>" data-card="hospital_veterinario">
            <div class="pc-top">
              <span class="pc-ico" style="color:#a47bff"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('maki-animal-shelter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?></span>
              <?php if($currentPlan === 'hospital_veterinario'): ?>
                <span class="pc-badge">Plan actual</span>
              <?php endif; ?>
            </div>
            <h4><?php echo e($storagePlans['hospital_veterinario']['label']); ?></h4><div class="pc-gb"><?php echo e($fmtGb($storagePlans['hospital_veterinario']['gb_per_person'])); ?> por persona</div>
            <div class="pc-gb"><?php echo e($fmtGb($storagePlans['hospital_veterinario']['total_gb_for_current_people'])); ?> para <?php echo e($storageSummary['person_count']); ?> <?php echo e($storageSummary['person_count'] === 1 ? 'persona activa' : 'personas activas'); ?></div>
            <ul class="pc-feat">
            ...
            <a href="#" class="pc-cta <?php echo e($currentPlan === 'hospital_veterinario' || !$isClinicOwner ? 'disabled' : ''); ?>" data-plan="hospital_veterinario" data-interval="month">
              <?php echo e($currentPlan === 'hospital_veterinario' ? 'Plan actual' : ($isClinicOwner ? 'Cambiar a Hospital Veterinario' : 'Solo el propietario')); ?>

            </a>
          </div>

          <div class="pl-card <?php echo e($currentPlan === 'red_veterinaria' ? 'current' : ''); ?>" data-card="red_veterinaria">
            <div class="pc-top">
              ...
              <?php if($currentPlan === 'red_veterinaria'): ?>
                <span class="pc-badge">Plan actual</span>
              <?php endif; ?>
            </div>
            <h4><?php echo e($storagePlans['red_veterinaria']['label']); ?></h4><div class="pc-gb"><?php echo e($fmtGb($storagePlans['red_veterinaria']['gb_per_person'])); ?> por persona</div>
            <div class="pc-gb"><?php echo e($fmtGb($storagePlans['red_veterinaria']['total_gb_for_current_people'])); ?> para <?php echo e($storageSummary['person_count']); ?> <?php echo e($storageSummary['person_count'] === 1 ? 'persona activa' : 'personas activas'); ?></div>
            <ul class="pc-feat">
            ...
            <a href="#" class="pc-cta <?php echo e($currentPlan === 'red_veterinaria' || !$isClinicOwner ? 'disabled' : ''); ?>" data-plan="red_veterinaria" data-interval="month">
              <?php echo e($currentPlan === 'red_veterinaria' ? 'Plan actual' : ($isClinicOwner ? 'Cambiar a Red Veterinaria' : 'Solo el propietario')); ?>
...
<?php /**PATH C:\Users\LENOVO\enclaii-backend\resources\views/configuracion/sections/plan/_panel.blade.php ENDPATH**/ ?>