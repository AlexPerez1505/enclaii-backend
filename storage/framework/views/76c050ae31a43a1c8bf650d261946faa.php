  ...
  <form id="pacienteForm" class="form-card rise d2" action="<?php echo e(route('pacientes.update', $paciente)); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="personal-layout">
      ...
      <div class="form-group">
        ...
        <input type="tel" name="telefono" value="<?php echo e(old('telefono', $paciente->telefono)); ?>" placeholder="7221620815" maxlength="10" inputmode="numeric" oninput="this.value = this.value.replace(/\D/g,'').slice(0,10)">
      </div>
